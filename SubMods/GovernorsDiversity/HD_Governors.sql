...
-- 金融中心
	...
	('REYNA_CONTRACTOR_GOLD_COMMERCIAL',					'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',		'CITY_HAS_DISTRICT_COMMERCIAL_HUB_TIER_3_BUILDING_REQUIREMENTS'),
...
-- 跨国公司
	('REYNA_MULTINATIONAL_CORP_TRADE_GOLD_1',					'MODIFIER_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_FOR_INTERNATIONAL',		'CITY_HAS_DISTRICT_COMMERCIAL_HUB_TIER_1_BUILDING_REQUIREMENTS'),
	('REYNA_MULTINATIONAL_CORP_TRADE_GOLD_2',					'MODIFIER_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_FOR_INTERNATIONAL',		'CITY_HAS_DISTRICT_COMMERCIAL_HUB_TIER_2_BUILDING_REQUIREMENTS'),
	('REYNA_MULTINATIONAL_CORP_TRADE_GOLD_3',					'MODIFIER_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_FOR_INTERNATIONAL',		'CITY_HAS_DISTRICT_COMMERCIAL_HUB_TIER_3_BUILDING_REQUIREMENTS'),
...
values
	...
	('FISHERY_EXTRA_PRODUCTION_ON_FEATURE',				'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS',				'PLOT_HAS_ANY_FEATURE');
...
values
	(710,	'IMPROVEMENT_FISHERY',		'YIELD_GOLD',				3,								'CIVIC_MEDIEVAL_FAIRES',		null),
	...
	(713,	'IMPROVEMENT_FISHERY',		'YIELD_PRODUCTION',	1,								null,												'TECH_OCEANOGRAPHY_HD'),
	(714,	'IMPROVEMENT_FISHERY',		'YIELD_GOLD',				3,								null,												'TECH_STEAM_POWER'),
	(715,	'IMPROVEMENT_FISHERY',		'YIELD_FOOD',				1,								null,												'TECH_PLASTICS');
...
update Adjacency_YieldChanges set YieldType = 'YIELD_FOOD', YieldChange = 1 where ID = 'Fishery_SeaResourceAdjacency';
