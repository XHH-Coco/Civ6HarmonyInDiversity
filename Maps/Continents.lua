...
function GenerateMap()
	...
	local numLargeLakes = math.ceil(GameInfo.Maps[Map.GetMapSize()].Continents * 4 + 15); 
...
function GeneratePlotTypes(world_age)
	...
	while done == false do
		...
		if iNumBiggestAreaTiles <= iNumTotalLandTiles * 0.68 then
			done = true;
