...
function GenerateMap()
	...
	terrainTypes = GenerateTerrainTypes(plotTypes, g_iW, g_iH, g_iFlags, false, temperature,0, 0, 0, 0.03, -0.03,0.01);--保留沿海山
...
function AddFeatures()
	...
	local args = {rainfall = rainfall, iMarshPercent = 5, iSwampPercent = 4, iJunglePercent = 39, iForestPercent = 28} 
