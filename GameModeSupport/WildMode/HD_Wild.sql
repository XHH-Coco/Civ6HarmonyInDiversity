...
values
	...
	('ZEN_MEDITATION_CITY_CENTER_RIVER_CULTURE_MODIFIER',		'MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_CHANGE',		'CITYCENTER_ADJACENT_TO_RIVER_REQUIREMENTS'),
    ('ZEN_MEDITATION_HOLY_SITE_RIVER_CULTURE',				    'MODIFIER_ALL_CITIES_ATTACH_MODIFIER',					'CITY_FOLLOWS_RELIGION_REQUIREMENTS'),
	('ZEN_MEDITATION_HOLY_SITE_RIVER_CULTURE_MODIFIER',		    'MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_CHANGE',		'HOLYSITE_ADJACENT_TO_RIVER_REQUIREMENTS');
