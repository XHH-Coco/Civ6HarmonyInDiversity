...
values
    ...
    ("LOC_GAME_CAPTURE_SETTLERS_AS_BUILDERS",               "Slower pace of the world era changes"),
    ("LOC_GAME_CAPTURE_SETTLERS_AS_BUILDERS_DESCRIPTION",   "The speed of the changing times in the world will slow down."),
    ...
    ("LOC_GAMEMODE_AITEST_NAME",                            "Challenger Mode"),
    ("LOC_GAMEMODE_AITEST_DESCRIPTION",                     "If you're tired of [COLOR_Red] easy [ENDCOLOR] Deity difficulty, try [COLOR_Civ6LightBlue] Challenger Mode [ENDCOLOR]!"),
    ...
    ("LOC_MAP_WET_LAKES2_DESCRIPTION",                      "In areas with abundant rainfall, there are numerous overflowing rivers and waterlogged swamps both inside and outside the jungle."),
    ("LOC_MAP_HIGHLANDS_NAME",                              "Caucasus Mountains"),
    ("LOC_MAP_HIGHLANDS_DESCRIPTION",                       "In areas with higher altitudes, hills and mountains divide the valleys and plains."),
    ("LOC_MAP_FOREST_HIGHLANDS_NAME",                       "Guiana Highlands"),
    ("LOC_MAP_FOREST_HIGHLANDS_DESCRIPTION",                "In areas with higher altitudes, they are covered by rainforests and forests."),
    ("LOC_MAP_NEW_HIGHLANDS_NAME",                          "Deccan Plateau"),
    ("LOC_MAP_NEW_HIGHLANDS_DESCRIPTION",                   "In areas with higher altitudes, there are winding and undulating mountains, and the forest cover is sparse."),
    ("LOC_MAP_NORTHERN_MOUNTAINS_NAME",                     "Borean Tundra"),
    ("LOC_MAP_NORTHERN_MOUNTAINS_DESCRIPTION",              "Cold regions with low temperatures."),
    ("LOC_MAP_FROZEN_CONTINENTS_NAME",                      "Frozen Continent"),
...
values
    ...
    ("zh_Hans_CN",  "LOC_GAME_CAPTURE_SETTLERS_AS_BUILDERS",                "更慢的世界时代更迭速度"),
    ("zh_Hans_CN",  "LOC_GAME_CAPTURE_SETTLERS_AS_BUILDERS_DESCRIPTION",    "世界时代更迭的速度将会变慢。"),
    ...
    ("zh_Hans_CN",  "LOC_GAME_TESTING_OPTION",                              "[测试用]全免费，无弹窗"),
    ("zh_Hans_CN",  "LOC_GAME_TESTING_OPTION_DESCRIPTION",                  "用于测试的选项，所有的科技、市政、区域、建筑和单位均为最低花费，禁用科技/市政相关弹窗与历史时刻的弹窗。"),
    -- GameModes
    ("zh_Hans_CN",  "LOC_GAMEMODE_MILITARY_NAME",                           "军事拓展模式"),
    ("zh_Hans_CN",  "LOC_GAMEMODE_MILITARY_DESCRIPTION",                    "当前模式中新增了8个陆地作战单位和2个陆地支援单位。[NEWLINE][NEWLINE]劫掠消耗移动力改为2； [NEWLINE]击杀主要文明和城邦单位时获得等同于被击杀单位战斗力25%的大军点/提督点；[NEWLINE]攻占城市后获得等同于剩余人口数*30的金币，建造军阀宝座后翻倍; [NEWLINE]允许打蛮子升到3级（3级以后最多获得1经验，本体是2级）"),
    ("zh_Hans_CN",  "LOC_GAMEMODE_DEVTEST_NAME",                            "测试开发模式"),
    ("zh_Hans_CN",  "LOC_GAMEMODE_DEVTEST_DESCRIPTION",                     "[COLOR_Red]未完成的模式，请勿开启[ENDCOLOR]。用于测试的模式，当前测试模式包含了开发中内容。"),
	("zh_Hans_CN",  "LOC_GAMEMODE_RILIGIOUS_ARM_NAME",                      "宗教武装模式"),
    ("zh_Hans_CN",  "LOC_GAMEMODE_RILIGIOUS_ARM_DESCRIPTION",               "[COLOR_Red]未完成的模式，非内部测试人员请勿开启[ENDCOLOR]。添加了新单位类型：宗教武装。添加和改动了一些单位、信条和城邦。"),
    ("zh_Hans_CN",  "LOC_GAMEMODE_AITEST_NAME",                             "挑战者模式"),
    ("zh_Hans_CN",  "LOC_GAMEMODE_AITEST_DESCRIPTION",                      "如果你厌倦了[COLOR_Red]简单的[ENDCOLOR]“神级难度”，来尝试一下[COLOR_Civ6LightBlue]挑战者模式[ENDCOLOR]吧！"),
    ...
    ("zh_Hans_CN",  "LOC_GAMEMODE_WILD_DESCRIPTION",                        "[COLOR_Red]此未完成的模式，请勿开启[ENDCOLOR]。用于测试一些想法的模式。"),
    ("zh_Hans_CN",  "LOC_GAMEMODE_MONOPOLIES_NAME",                         "行业与公司模式"),
    ("zh_Hans_CN",  "LOC_GAMEMODE_MONOPOLIES_DESCRIPTION",                  "[COLOR_Magenta]请在新季票环境订阅并启用“和而不同”行业与公司模式独立MOD，我们对该模式进行了全面的重制，包括行业、公司和产品的效果。[ENDCOLOR][NEWLINE][NEWLINE]控制、改良您的奢侈品资源，并在此之上进行拓展！在“行业与公司”模式中，您可以围绕奢侈品资源建立利润丰硕的行业、创建公司进行深度开发，并生产特色产品，确立您在商业历史中的显著地位。"),
    ...
    ("zh_Hans_CN",  "LOC_MAP_WET_LAKES2_DESCRIPTION",                       "降水量充沛的地区，丛林内外到处是泛滥的河流和积水的沼泽。"),
    ...
    ("zh_Hans_CN",  "LOC_MAP_NORTHERN_MOUNTAINS_DESCRIPTION",               "气温较低的寒冷地区。"),
    ...
    ("zh_Hans_CN",  "LOC_MAP_SMALL_CONTINENTS_DESCRIPTION",                 "海洋和小岛环绕着气候各不相同的几个小型大陆。"),
    ("zh_Hans_CN",  "LOC_MAP_SPLINTERED_FRACTAL_DESCRIPTION",               "此处陆地十分狭长，如同花瓣弯曲着散落一般，而周围是众多岛屿和深浅不一的海洋。先人一步登上新大陆吧。");