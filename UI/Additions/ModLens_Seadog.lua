-- Modified from More Lenses by astor
-- Original Mod https://steamcommunity.com/sharedfiles/filedetails/?id=871712879
-- Thank astor
local LENS_NAME = "HD_SEADOG"
local ML_LENS_LAYER = UILens.CreateLensLayerHash("Hex_Coloring_Appeal_Level")

-- Should the seadog lens auto apply, when a seadog is selected.
...
local ScoutLensEntry = {
    LensButtonText = "LOC_HUD_SEADOG_LENS",
    LensButtonTooltip = "LOC_HUD_SEADOG_LENS_TOOLTIP",
