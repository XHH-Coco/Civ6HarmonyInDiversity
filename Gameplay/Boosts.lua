...
function PlayerCompleteMomentBoost(playerId, momentId)
  local momentInfo = GameInfo.Moments[momentId]
...
GameEvents.HDPlayerCompleteMoment.Add(PlayerCompleteMomentBoost);
--------------------------------------------------------------
-- Initialize
function initialize()
