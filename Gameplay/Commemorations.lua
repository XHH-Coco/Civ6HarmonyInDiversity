    ...
    if Utils.PlayerHasCommemoration(ownerId, COMMEMORATION_HD_MEGA_CORPORATION_INDEX) then
      if not (Utils.PlayerHasHeroicGoldenAge(ownerId) or Utils.PlayerHasGoldenAge(ownerId)) then
        ...
        if (IMPROVEMENT_INDUSTRY_INFO and improvementId == IMPROVEMENT_INDUSTRY_INFO.Index)
          or (IMPROVEMENT_INDUSTRY_BONUS_INFO and improvementId == IMPROVEMENT_INDUSTRY_BONUS_INFO.Index) 
          or (IMPROVEMENT_INDUSTRY_STRATEGIC_INFO and improvementId == IMPROVEMENT_INDUSTRY_STRATEGIC_INFO.Index) 
          or (IMPROVEMENT_CORPORATION_INFO and improvementId == IMPROVEMENT_CORPORATION_INFO.Index) 
          or (IMPROVEMENT_CORPORATION_BONUS_INFO and improvementId == IMPROVEMENT_CORPORATION_BONUS_INFO.Index) 
