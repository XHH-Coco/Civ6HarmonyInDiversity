	...
	if improvementInfo ~= nil then
		...
		or improvementType == 'IMPROVEMENT_WIND_FARM' then
			...
			if improvementType == 'IMPROVEMENT_INDUSTRY' or improvementType == 'IMPROVEMENT_INDUSTRY_BONUS' or improvementType == 'IMPROVEMENT_INDUSTRY_STRATEGIC' then
				SumeriaCompleteSpecialQuest(playerId, 'HD_SPECIAL_QUEST_BUILD_SPECIAL_IMPROVEMENT', 'HD_SPECIAL_SUBQUEST_BUILD_' .. improvementType, 'IMPROVEMENT_INDUSTRY');
				SumeriaCompleteSpecialQuest(playerId, 'HD_SPECIAL_QUEST_BUILD_SPECIAL_IMPROVEMENT', 'HD_SPECIAL_SUBQUEST_BUILD_' .. improvementType, 'IMPROVEMENT_INDUSTRY_BONUS');
				SumeriaCompleteSpecialQuest(playerId, 'HD_SPECIAL_QUEST_BUILD_SPECIAL_IMPROVEMENT', 'HD_SPECIAL_SUBQUEST_BUILD_' .. improvementType, 'IMPROVEMENT_INDUSTRY_STRATEGIC');
			elseif improvementType == 'IMPROVEMENT_CORPORATION' or improvementType == 'IMPROVEMENT_CORPORATION_BONUS' or improvementType == 'IMPROVEMENT_CORPORATION_STRATEGIC' then
				SumeriaCompleteSpecialQuest(playerId, 'HD_SPECIAL_QUEST_BUILD_SPECIAL_IMPROVEMENT', 'HD_SPECIAL_SUBQUEST_BUILD_' .. improvementType, 'IMPROVEMENT_CORPORATION');
				SumeriaCompleteSpecialQuest(playerId, 'HD_SPECIAL_QUEST_BUILD_SPECIAL_IMPROVEMENT', 'HD_SPECIAL_SUBQUEST_BUILD_' .. improvementType, 'IMPROVEMENT_CORPORATION_BONUS');
				SumeriaCompleteSpecialQuest(playerId, 'HD_SPECIAL_QUEST_BUILD_SPECIAL_IMPROVEMENT', 'HD_SPECIAL_SUBQUEST_BUILD_' .. improvementType, 'IMPROVEMENT_CORPORATION_STRATEGIC');
			else
