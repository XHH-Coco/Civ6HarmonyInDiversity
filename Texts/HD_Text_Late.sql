...
update LocalizedText set Text = Text || '[NEWLINE][NEWLINE]Recon: Faster [ICON_Movement] Movement in Hills, Woods and Rainforest terrain.' where Language = 'en_US' and (
    ...
    Tag = 'LOC_UNIT_VELITE_DESCRIPTION' or
    Tag = 'LOC_UNIT_CHASSEUR_DESCRIPTION' or
...
--------------------------------------------------------------------------------
-- Language: zh_Hans_CN
update LocalizedText set Text = Text || '[NEWLINE][NEWLINE]侦察：无视丘陵、森林和雨林对 [ICON_MOVEMENT] 移动力的减益。' where Language = 'zh_Hans_CN' and (
    Tag = 'LOC_UNIT_SCOUT_DESCRIPTION' or
    Tag = 'LOC_UNIT_VELITE_DESCRIPTION' or
    Tag = 'LOC_UNIT_CHASSEUR_DESCRIPTION' or
    Tag = 'LOC_UNIT_RANGER_DESCRIPTION' or
    ...
    Tag = 'LOC_UNIT_INCA_CHASQUI_DESCRIPTION' or
    Tag = 'LOC_UNIT_MAORI_TUPARA_DESCRIPTION' or
    Tag = 'LOC_UNIT_HD_BANDEIRANTES_DESCRIPTION' or
    Tag = 'LOC_UNIT_UNIT_VELITE_DESCRIPTION' or
    Tag = 'LOC_UNIT_UNIT_CHASSEUR_DESCRIPTION' or
    Tag = 'LOC_UNIT_MAPUCHE_GUERILLA_DESCRIPTION');
...
update LocalizedText set Text = Text || '[NEWLINE][NEWLINE]抗骑兵：防御骑兵单位时额外+10 [ICON_Strength] 战斗力。' where Language = 'zh_Hans_CN' and (
    Tag = 'LOC_UNIT_SPEARMAN_DESCRIPTION' or
    Tag = 'LOC_UNIT_HALBERDMAN_DESCRIPTION' or
    Tag = 'LOC_UNIT_ARRAY_INFANTRY_DESCRIPTION' or
    Tag = 'LOC_UNIT_GREEK_HOPLITE_DESCRIPTION' or
    Tag = 'LOC_UNIT_PIKEMAN_DESCRIPTION' or
    Tag = 'LOC_UNIT_AT_CREW_DESCRIPTION' or
    Tag = 'LOC_UNIT_MODERN_AT_DESCRIPTION' or
