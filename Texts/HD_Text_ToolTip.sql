insert or replace into EnglishText (Tag, Text) values
  ...
  ("LOC_TOOLTIP_HD_IMPROVEMENT_CLASSIFICATIONS_TEXT",   "Improvement Classifications:"),
  ...
  ("LOC_TOOLTIP_HD_ADJACENCIES_DISTRICT_INCLUDING_UD_TEXT",     "{1_Amount: number +#,###.#;-#,###.#} {2_YieldIcon} {3_YieldName} from each adjacent {5_AdjacentObject} or corresponding unique district tile."),
  ("LOC_TOOLTIP_HD_ADJACENCIES_DISTRICT_INCLUDING_UD_PER_TEXT", "{1_Amount: number +#,###.#;-#,###.#} {2_YieldIcon} {3_YieldName} from every {4_Count} adjacent {5_AdjacentObject} or corresponding unique district tiles."),
...
insert or replace into LocalizedText (Language, Tag, Text) values
  ...
  ("zh_Hans_CN", "LOC_TOOLTIP_HD_IMPROVEMENT_CLASSIFICATIONS_TEXT",   "改良分类："),
  ...
  ("zh_Hans_CN", "LOC_TOOLTIP_HD_ADJACENCIES_DISTRICT_INCLUDING_UD_TEXT",     "{1_Amount: number +#,###.#;-#,###.#} {2_YieldIcon} {3_YieldName}，来自每个相邻{5_AdjacentObject}，或对应特色区域"),
  ("zh_Hans_CN", "LOC_TOOLTIP_HD_ADJACENCIES_DISTRICT_INCLUDING_UD_PER_TEXT", "{1_Amount: number +#,###.#;-#,###.#} {2_YieldIcon} {3_YieldName}，来自每{4_Count}个相邻{5_AdjacentObject}，或对应特色区域"),
