insert or replace into EnglishText (Tag, Text) values
  ...
  ("LOC_HD_HYDRAULIC_DISTRICTS_PRODUCTION_TEXT",  										"+{1_num} [ICON_Production] Production from adjacent Hydraulic {1_Num : plural 1?District; other?Districts;}"),
	...
	("LOC_HD_NEIGHBORHOOD_INCLUDING_UD_FAITH_TEXT",											"+{1_num} [ICON_FAITH] Faith from adjacent Neighborhood {1_Num : plural 2?district; other?districts;} or corresponding unique {1_Num : plural 2?district; other?districts;}"),
  ...
  ("LOC_HD_ENCAMPMENT_INCLUDING_UD_PRODUCTION_TEXT",									"+{1_num} [ICON_PRODUCTION] Production from adjacent Commercial Hub {1_Num : plural 2?district; other?districts;} or corresponding unique {1_Num : plural 2?district; other?districts;}"),
	("LOC_HD_HOLY_SITE_INCLUDING_UD_GOLD_TEXT",													"+{1_num} [ICON_Gold] Gold from adjacent Holy Site {1_Num : plural 2?district; other?districts;} or corresponding unique {1_Num : plural 2?district; other?districts;}"),
	("LOC_HD_NEIGHBORHOOD_INCLUDING_UD_CULTURE_TEXT",										"+{1_num} [ICON_Culture] Culture from adjacent Neighborhood {1_Num : plural 2?district; other?districts;} or corresponding unique {1_Num : plural 2?district; other?districts;}"),
  ...
  ("LOC_HD_WAT_ARUN_YIELD_GOLD",					      "+{1_num} [ICON_GOLD] Gold from the adjacent {1_num : plural 1?Floodplain; other?Floodplains;}"),
	...
	("LOC_DISTRICT_HANSA_PRODUCTION",							"+{1_num} [ICON_PRODUCTION] Production from the adjacent Hansa {1_Num : plural 2?district; other?districts;}"),
...
insert or replace into LocalizedText (Language, Tag, Text) values
  ...
  ("zh_Hans_CN",  "LOC_HD_NEIGHBORHOOD_INCLUDING_UD_FAITH_TEXT",										"+{1_num} [ICON_FAITH] 信仰值来自相邻社区，或对应特色区域"),
  ...
  ("zh_Hans_CN",  "LOC_HD_HOLY_SITE_INCLUDING_UD_GOLD_TEXT",												"+{1_num} [ICON_GOLD] 金币来自相邻圣地，或对应特色区域"),
  ("zh_Hans_CN",  "LOC_HD_NEIGHBORHOOD_INCLUDING_UD_CULTURE_TEXT",									"+{1_num} [ICON_CULTURE] 文化值来自相邻社区，或对应特色区域"),
  ...
  ("zh_Hans_CN",  "LOC_HD_WAT_ARUN_YIELD_GOLD",					        "+{1_num} [ICON_GOLD] 金币来自相邻泛滥平原"),
		-- Adjacent to district
	("zh_Hans_CN",	"LOC_DISTRICT_HANSA_GOLD",							"+{1_num} [ICON_GOLD] 金币来自相邻汉萨同盟"),
	("zh_Hans_CN",	"LOC_DISTRICT_HANSA_PRODUCTION",							"+{1_num} [ICON_PRODUCTION] 生产力来自相邻汉萨同盟"),
