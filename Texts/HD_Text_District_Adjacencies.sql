insert or replace into EnglishText (Tag, Text) values
  ...
  ("LOC_HD_HYDRAULIC_DISTRICTS_PRODUCTION_TEXT",  										"+{1_num} [ICON_Production] Production from adjacent Hydraulic {1_Num : plural 1?District; other?Districts;}"),
	...
	("LOC_HD_TRANSPOTATION_IMPROVEMENT_PRODUCTION_TEXT",   							"+{1_num} [ICON_Production] Production from adjacent Transportation {1_Num : plural 1?Improvement; other?Improvements;}"),
...
insert or replace into LocalizedText (Language, Tag, Text) values
  ...
  ("zh_Hans_CN",  "LOC_HD_TRANSPOTATION_IMPROVEMENT_PRODUCTION_TEXT",  							"+{1_num} [ICON_Production] 生产力来自相邻交通设施改良"),
