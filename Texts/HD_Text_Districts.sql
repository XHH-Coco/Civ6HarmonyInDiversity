...
values
	...
	-- 保护区
	("LOC_DISTRICT_PRESERVE_HD_DESCRIPTION",							"+1 [ICON_FOOD] Food. [NEWLINE]Triggers a Cultural Bomb on adjacent neutral tiles. Can be built on Forests, Rainforests and Marshes. Feature tiles in this city do not decrease the Appeal of adjacent tiles. Provides +1 Appeal to adjacent tiles. [NEWLINE][NEWLINE]Award +1 [ICON_GOVERNOR] Governor Title for the first time 5 kinds of Conservation Department buildings are all built. Award 4 different types of policy slots for the first time 4 kinds of Agency buildings are all built."),
	-- 商业中心
	("LOC_DISTRICT_COMMERCIAL_HUB_HD_DESCRIPTION",					"A district in your city specializing in finance and trade. +3 [ICON_Gold] Gold for adjacent Improvements. +2 [ICON_Gold] Gold from [ICON_TradeRoute] Trade Routes starting from this city."),
	("LOC_DISTRICT_SUGUBA_HD_DESCRIPTION",							"A district unique to Mali specializing in finance and trade that replaces the Commercial Hub, gains major adjacency bonus when adjacent to Holy Site Districts. Enable purchasing Districts with [ICON_Gold] Gold in this city. Units, Buildings, and Districts are 15% cheaper to purchase with [ICON_GOLD] Gold and [ICON_FAITH] Faith in this City.[NEWLINE][NEWLINE]+3 [ICON_Gold] Gold for adjacent Improvements. +2 [ICON_Gold] Gold from all [ICON_TradeRoute] Trade Routes originated from this city."),
	-- 运河
...
values
	...
	-- 港口
	("zh_Hans_CN",	"LOC_DISTRICT_HARBOR_HD_DESCRIPTION",							"城市中的海军活动区域。同时取消从该单元格上下船的 [ICON_Movement] 移动力消耗。必须修建在和陆地相邻的海岸或湖泊单元格上。如此城与海岸或湖边相邻，则+2 [ICON_HOUSING] 住房。建造海军单位加速10%。允许开拓者上船。"),
	("zh_Hans_CN",	"LOC_DISTRICT_COTHON_HD_DESCRIPTION",							"腓尼基特色城市海军活动区域，取代港口且建造成本更低。必须修建在和陆地相邻的海岸或湖泊单元格上。[NEWLINE][NEWLINE]海军单位在此城驻扎一回合可完全恢复。建成时，其所在水域若与 [ICON_Capital] 首都的U型港相同，则+1 [ICON_TRADEROUTE] 贸易路线容量。如此城与海岸或湖边相邻，则+2 [ICON_HOUSING] 住房。允许开拓者上船。"),
	("zh_Hans_CN",	"LOC_DISTRICT_ROYAL_NAVY_DOCKYARD_HD_DESCRIPTION",				"城市中的英国特色海军活动区域，取代港口且建造成本更低。同时移除该单元格的上船、下船 [ICON_Movement] 移动力减益。必须建在与陆地相邻的海岸或湖泊地形上。如此城与海岸或湖边相邻，则+2 [ICON_HOUSING] 住房。建造海军单位加速10%。皇家海军船坞中建造的所有海军单位+1 [ICON_Movement] 移动力。本城建造的所有陆地单位忽略来自上船和下船的额外 [ICON_MOVEMENT] 移动力消耗。每相邻1个工业区+2 [ICON_Gold] 金币。本城正确改良的战略每回合积累+2。允许开拓者上船。"),
	-- 军营
	...
	-- 保护区
	("zh_Hans_CN",	"LOC_DISTRICT_PRESERVE_HD_DESCRIPTION",							"+1 [ICON_FOOD] 食物。[NEWLINE]对相邻的中立单元格施放文化炸弹。可以建造在森林、雨林或沼泽上。本城的地貌不再降低魅力。为相邻单元格+1魅力。[NEWLINE][NEWLINE]文明中首次建成5种不同的保护部建筑，奖励1个 [ICON_GOVERNOR] 总督头衔，首次建成4种不同的专局建筑，奖励4种不同的政策槽位各一个。"),
	-- 商业中心
	("zh_Hans_CN",	"LOC_DISTRICT_COMMERCIAL_HUB_HD_DESCRIPTION",					"城市中专注于金融和贸易的区域。为相邻的改良设施+3 [ICON_Gold] 金币。本城出发的 [ICON_TradeRoute] 贸易路线+2 [ICON_Gold] 金币。"),
	("zh_Hans_CN",	"LOC_DISTRICT_SUGUBA_HD_DESCRIPTION",							"马里特色区域，专精于经济与贸易，替代“商业中心”，与圣地相邻获得大相邻加成。允许本城使用金币购买区域。使用 [ICON_GOLD] 金币和 [ICON_FAITH] 信仰值在此城中购买单位、建筑和区域时，费用减少15%。[NEWLINE][NEWLINE]为相邻的改良设施+3 [ICON_Gold] 金币。本城出发的 [ICON_TradeRoute] 贸易路线+2 [ICON_Gold] 金币。"), --[NEWLINE][NEWLINE]每相邻一个圣地获得+2 [ICON_Gold] 金币加成。每相邻一个港口获得+2 [ICON_Gold] 金币加成。
	-- 运河
	...
	("zh_Hans_CN",	"LOC_DISTRICT_HIPPODROME_HD_DESCRIPTION",						"拜占庭特色区域。替代“娱乐中心”，且建造花费更低。+2 [ICON_Amenities] 宜居度。相邻牧场或营地时额外+1 [ICON_Amenities] 宜居度。从每个相邻的资源获得+1 [ICON_Culture] 文化值。为相邻单元格提供+1魅力。[NEWLINE][NEWLINE]首次建成后解锁“骑马”和“马鞍”科技。建成跑马场及其中的建筑时，将获得一个无需消耗资源维护的重骑兵单位。"),
	-- 社区
