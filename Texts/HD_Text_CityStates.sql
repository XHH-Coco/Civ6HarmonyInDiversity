...
values
    ...
    ("LOC_LEADER_TRAIT_ARMAGH_EXPANSION2_DESCRIPTION",    "Holy Site districts provide +2 [ICON_GREATPROPHET] Great Prophet points. After you have founded a Religion, provides [ICON_GREATWRITER] Great Writer points equal to excess [ICON_GREATPROPHET] Great Prophet points."),
    ("LOC_LEADER_TRAIT_NALANDA_DESCRIPTION",              "+2 [ICON_SCIENCE] Science to Religious Improvements. +3 [ICON_FAITH] Faith to Wonders."),
    ("LOC_LEADER_TRAIT_SAMARKAND_DESCRIPTION",            "International [ICON_TRADEROUTE] Trade Routes receive +4 [ICON_GOLD] Gold for every Luxury resource at the destination."),
    ...
    ("LOC_LEADER_TRAIT_AUCKLAND_DESCRIPTION",             "+1 [ICON_PRODUCTION] Production from Shallow Sea and Lake tiles. Extra +1 [ICON_PRODUCTION] Production after researching 'Steam Power'."),
    ...
    ("LOC_LEADER_TRAIT_MEXICO_CITY_DESCRIPTION",          "Newly trained Builders get +1 [ICON_CHARGES] build charge."),
    ...
    ("LOC_LEADER_TRAIT_NAN_MADOL_DESCRIPTION",            "Your Districts(except City center) and Wonders on or next to Shallow Sea and Lake tiles provide +1 [ICON_Culture] Culture."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_ARMAGH_EXPANSION2_DESCRIPTION",    "圣地提供+2 [ICON_GreatProphet] 大预言家点数。创立宗教后，获得与超量 [ICON_GREATPROPHET] 大预言家点数等量的 [ICON_GREATWRITER] 大作家点数。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_NALANDA_DESCRIPTION",              "宗教场所改良+2 [ICON_SCIENCE] 科技值。奇观+3 [ICON_FAITH] 信仰值。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_SAMARKAND_DESCRIPTION",            "国际 [ICON_TRADEROUTE] 贸易路线从目的地城市的每个奢侈资源获得+4 [ICON_GOLD] 金币。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_ANTANANARIVO_DESCRIPTION",         "您的文明每获得1位伟人，[ICON_Culture] 文化值便+1%（上限为+15%）。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_AKKAD_DESCRIPTION",                "可以使用 [ICON_FAITH] 信仰值购买支援单位。陆地战斗单位可利用自身的 [ICON_Movement] 移动力护送平民和支援单位。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_KABUL_DESCRIPTION",                "您的单位由他们发起的战斗中获得额外100%经验值。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_AUCKLAND_DESCRIPTION",             "浅海与湖泊单元格+1 [ICON_PRODUCTION] 生产力，研究“蒸汽动力”后额外+1 [ICON_PRODUCTION] 生产力。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_CHINGUETTI_DESCRIPTION",           "此城中每有1位您所创建（或主流）宗教的信徒，国际与国内 [ICON_TradeRoute] 贸易路线提供的 [ICON_FAITH] 信仰值便+0.3。所有 [ICON_TRADEROUTE] 贸易路线+3 [ICON_FAITH] 信仰值。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_BOLOGNA_DESCRIPTION",              "每个区域提供+3对应 [ICON_GreatPerson] 伟人点数。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_VATICAN_CITY_DESCRIPTION",         "有奇观的城市的圣地从相邻的区域获得标准相邻加成。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_BABYLON_DESCRIPTION",              "位于丘陵之上或靠近山脉的学院+3 [ICON_SCIENCE] 科技值。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_JAKARTA_DESCRIPTION",              "您境内位于或与浅海与湖泊单元格相邻的区域（市中心外）和奇观+3 [ICON_Gold] 金币。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_MEXICO_CITY_DESCRIPTION",          "新训练的建造者+1 [ICON_CHARGES] 建造次数"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_NAN_MADOL_DESCRIPTION",            "您境内位于或与浅海与湖泊单元格相邻的区域（市中心外）和奇观+1 [ICON_CULTURE] 文化值。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_GENEVA_DESCRIPTION",               "当您不与任何文明发生战争时，您的城市+10% [ICON_SCIENCE] 科技值。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_JOHANNESBURG_DESCRIPTION",         "城市中每种已改良的矿山或采石场资源为该城市+1 [ICON_PRODUCTION] 生产力和+3 [ICON_GOLD] 金币。研究“学徒”科技后额外+1 [ICON_PRODUCTION] 生产力。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_BUENOS_AIRES_DESCRIPTION",         "每个基础相邻加成至少+9的区域为所在城市提供+9%对应产出。"),
...
insert or replace into EnglishText
    (Tag,                                                       Text)
values
    ("LOC_CSE_BONUS_PREFIX",                                    "In cities you founded: "),
    ("LOC_CSE_SCIENTIFIC_TRAIT_SMALL_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}+1 [ICON_SCIENCE] Science from every *."),
    ("LOC_CSE_SCIENTIFIC_TRAIT_MEDIUM_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}+2 [ICON_SCIENCE] Science from every *."),
    ("LOC_CSE_SCIENTIFIC_TRAIT_LARGE_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}+3 [ICON_SCIENCE] Science from every *."),
    ("LOC_CSE_SCIENTIFIC_TRAIT_LARGEST_INFLUENCE_BONUS",        "{LOC_CSE_BONUS_PREFIX}+4 [ICON_SCIENCE] Science from every *."),
    ("LOC_CSE_CULTURAL_TRAIT_SMALL_INFLUENCE_BONUS",            "{LOC_CSE_BONUS_PREFIX}+1 [ICON_CULTURE] Culture from every *."),
    ("LOC_CSE_CULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}+2 [ICON_CULTURE] Culture from every *."),
    ("LOC_CSE_CULTURAL_TRAIT_LARGE_INFLUENCE_BONUS",            "{LOC_CSE_BONUS_PREFIX}+3 [ICON_CULTURE] Culture from every *."),
    ("LOC_CSE_CULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}+4 [ICON_CULTURE] Culture from every *."),
    ("LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS",               "{LOC_CSE_BONUS_PREFIX}+3 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS",              "{LOC_CSE_BONUS_PREFIX}+6 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS",               "{LOC_CSE_BONUS_PREFIX}+9 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS",             "{LOC_CSE_BONUS_PREFIX}+12 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS_ALT",           "{LOC_CSE_BONUS_PREFIX}+3 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS_ALT",          "{LOC_CSE_BONUS_PREFIX}+6 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS_ALT",           "{LOC_CSE_BONUS_PREFIX}+9 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS_ALT",         "{LOC_CSE_BONUS_PREFIX}+12 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_RELIGIOUS_TRAIT_SMALL_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}+1 [ICON_FAITH] Faith from every *."),
    ("LOC_CSE_RELIGIOUS_TRAIT_MEDIUM_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}+3 [ICON_FAITH] Faith from every *."),
    ("LOC_CSE_RELIGIOUS_TRAIT_LARGE_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}+5 [ICON_FAITH] Faith from every *."),
    ("LOC_CSE_RELIGIOUS_TRAIT_LARGEST_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}+7 [ICON_FAITH] Faith from every *."),
    ("LOC_CSE_MILITARISTIC_TRAIT_SMALL_INFLUENCE_BONUS",        "{LOC_CSE_BONUS_PREFIX}+1 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_MILITARISTIC_TRAIT_MEDIUM_INFLUENCE_BONUS",       "{LOC_CSE_BONUS_PREFIX}+2 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_MILITARISTIC_TRAIT_LARGE_INFLUENCE_BONUS",        "{LOC_CSE_BONUS_PREFIX}+3 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_MILITARISTIC_TRAIT_LARGEST_INFLUENCE_BONUS",      "{LOC_CSE_BONUS_PREFIX}+4 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_INDUSTRIAL_TRAIT_SMALL_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}+1 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_INDUSTRIAL_TRAIT_MEDIUM_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}+2 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_INDUSTRIAL_TRAIT_LARGE_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}+3 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_INDUSTRIAL_TRAIT_LARGEST_INFLUENCE_BONUS",        "{LOC_CSE_BONUS_PREFIX}+4 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_AGRICULTURAL_TRAIT_SMALL_INFLUENCE_BONUS",        "{LOC_CSE_BONUS_PREFIX}+1 [ICON_FOOD] Food from every *."),
    ("LOC_CSE_AGRICULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS",       "{LOC_CSE_BONUS_PREFIX}+1 [ICON_FOOD] Food from every *."),
    ("LOC_CSE_AGRICULTURAL_TRAIT_LARGE_INFLUENCE_BONUS",        "{LOC_CSE_BONUS_PREFIX}+1 [ICON_FOOD] Food from every *."),
    ("LOC_CSE_AGRICULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",      "{LOC_CSE_BONUS_PREFIX}+2 [ICON_FOOD] Food from every *."),
    ("LOC_CSE_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS",            "{LOC_CSE_BONUS_PREFIX}+3 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}+6 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS",            "{LOC_CSE_BONUS_PREFIX}+9 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}+12 [ICON_GOLD] Gold from every *.");

insert or replace into LocalizedText
    (Language,      Tag,                                                        Text)
values
    ("zh_Hans_CN",  "LOC_CSE_BONUS_PREFIX",                                     "您建立的城市中"),
    ("zh_Hans_CN",  "LOC_CSE_SCIENTIFIC_TRAIT_SMALL_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}每座*+1 [ICON_Science] 科技值。"),
    ("zh_Hans_CN",  "LOC_CSE_SCIENTIFIC_TRAIT_MEDIUM_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}每座*+2 [ICON_Science] 科技值。"),
    ("zh_Hans_CN",  "LOC_CSE_SCIENTIFIC_TRAIT_LARGE_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}每座*+3 [ICON_Science] 科技值。"),
    ("zh_Hans_CN",  "LOC_CSE_SCIENTIFIC_TRAIT_LARGEST_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}每座*+4 [ICON_Science] 科技值。"),
    ("zh_Hans_CN",  "LOC_CSE_CULTURAL_TRAIT_SMALL_INFLUENCE_BONUS",             "{LOC_CSE_BONUS_PREFIX}每座*+1 [ICON_Culture] 文化值。"),
    ("zh_Hans_CN",  "LOC_CSE_CULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS",            "{LOC_CSE_BONUS_PREFIX}每座*+2 [ICON_Culture] 文化值。"),
    ("zh_Hans_CN",  "LOC_CSE_CULTURAL_TRAIT_LARGE_INFLUENCE_BONUS",             "{LOC_CSE_BONUS_PREFIX}每座*+3 [ICON_Culture] 文化值。"),
    ("zh_Hans_CN",  "LOC_CSE_CULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}每座*+4 [ICON_Culture] 文化值。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS",                "{LOC_CSE_BONUS_PREFIX}每座*+3 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS",               "{LOC_CSE_BONUS_PREFIX}每座*+6 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS",                "{LOC_CSE_BONUS_PREFIX}每座*+9 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS",              "{LOC_CSE_BONUS_PREFIX}每座*+12 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS_ALT",            "{LOC_CSE_BONUS_PREFIX}每座*+3 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS_ALT",           "{LOC_CSE_BONUS_PREFIX}每座*+6 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS_ALT",            "{LOC_CSE_BONUS_PREFIX}每座*+9 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS_ALT",          "{LOC_CSE_BONUS_PREFIX}每座*+12 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_RELIGIOUS_TRAIT_SMALL_INFLUENCE_BONUS",            "{LOC_CSE_BONUS_PREFIX}每座*+1 [ICON_Faith] 信仰值。"),
    ("zh_Hans_CN",  "LOC_CSE_RELIGIOUS_TRAIT_MEDIUM_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}每座*+3 [ICON_Faith] 信仰值。"),
    ("zh_Hans_CN",  "LOC_CSE_RELIGIOUS_TRAIT_LARGE_INFLUENCE_BONUS",            "{LOC_CSE_BONUS_PREFIX}每座*+5 [ICON_Faith] 信仰值。"),
    ("zh_Hans_CN",  "LOC_CSE_RELIGIOUS_TRAIT_LARGEST_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}每座*+7 [ICON_Faith] 信仰值。"),
    ("zh_Hans_CN",  "LOC_CSE_MILITARISTIC_TRAIT_SMALL_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}每座*+1 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_MILITARISTIC_TRAIT_MEDIUM_INFLUENCE_BONUS",        "{LOC_CSE_BONUS_PREFIX}每座*+2 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_MILITARISTIC_TRAIT_LARGE_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}每座*+3 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_MILITARISTIC_TRAIT_LARGEST_INFLUENCE_BONUS",       "{LOC_CSE_BONUS_PREFIX}每座*+4 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_INDUSTRIAL_TRAIT_SMALL_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}每座*+1 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_INDUSTRIAL_TRAIT_MEDIUM_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}每座*+2 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_INDUSTRIAL_TRAIT_LARGE_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}每座*+3 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_INDUSTRIAL_TRAIT_LARGEST_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}每座*+4 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_AGRICULTURAL_TRAIT_SMALL_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}每座*+1 [ICON_Food] 食物。"),
    ("zh_Hans_CN",  "LOC_CSE_AGRICULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS",        "{LOC_CSE_BONUS_PREFIX}每座*+1 [ICON_Food] 食物。"),
    ("zh_Hans_CN",  "LOC_CSE_AGRICULTURAL_TRAIT_LARGE_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}每座*+1 [ICON_Food] 食物。"),
    ("zh_Hans_CN",  "LOC_CSE_AGRICULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",       "{LOC_CSE_BONUS_PREFIX}每座*+2 [ICON_Food] 食物。"),
    ("zh_Hans_CN",  "LOC_CSE_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS",             "{LOC_CSE_BONUS_PREFIX}每座*+3 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS",            "{LOC_CSE_BONUS_PREFIX}每座*+6 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS",             "{LOC_CSE_BONUS_PREFIX}每座*+9 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}每座*+12 [ICON_Gold] 金币。");