...
values
    ...
    ("LOC_CSE_INDUSTRIAL_TRAIT_MEDIUM_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}+1 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_INDUSTRIAL_TRAIT_LARGE_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}+2 [ICON_PRODUCTION] Production from every *."),
    ("LOC_CSE_INDUSTRIAL_TRAIT_LARGEST_INFLUENCE_BONUS",        "{LOC_CSE_BONUS_PREFIX}+3 [ICON_PRODUCTION] Production from every *."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_CSE_INDUSTRIAL_TRAIT_MEDIUM_INFLUENCE_BONUS",          "{LOC_CSE_BONUS_PREFIX}每座*+1 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_INDUSTRIAL_TRAIT_LARGE_INFLUENCE_BONUS",           "{LOC_CSE_BONUS_PREFIX}每座*+2 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CSE_INDUSTRIAL_TRAIT_LARGEST_INFLUENCE_BONUS",         "{LOC_CSE_BONUS_PREFIX}每座*+3 [ICON_Production] 生产力。"),
