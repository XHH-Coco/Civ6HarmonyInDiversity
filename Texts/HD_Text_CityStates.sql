...
values
    ...
    --("LOC_CIVILIZATION_AUCKLAND_BONUS",                   "+1 [ICON_PRODUCTION] Production from Shallow Sea and Lake tiles. Extra +1 [ICON_PRODUCTION] Production after researching 'Steam Power'."),
    ...
    --("LOC_CIVILIZATION_BOLOGNA_BONUS",                    "+3 corresponding [ICON_GREATPERSON] Great Person Points for each Districts."),
...
values
    ...
    --("zh_Hans_CN",  "LOC_CIVILIZATION_AUCKLAND_BONUS",                   "浅海与湖泊单元格+1 [ICON_PRODUCTION] 生产力，研究“蒸汽动力”后额外+1 [ICON_PRODUCTION] 生产力。"),
    ...
    --("zh_Hans_CN",  "LOC_CIVILIZATION_NGAZARGAMU_BONUS",                 "军营从沙漠和沙漠丘陵获得少量相邻加成。相邻湖泊的军营提供等同于其相邻加成的 [ICON_FOOD] 食物。"),
    ...
    --("zh_Hans_CN",  "LOC_CIVILIZATION_BOLOGNA_BONUS",                    "每个区域提供+3对应 [ICON_GreatPerson] 伟人点数。"),
    ...
    --("zh_Hans_CN",  "LOC_CIVILIZATION_JAKARTA_BONUS",                    "您境内位于或与浅海与湖泊单元格相邻的区域（市中心外）和奇观+3 [ICON_Gold] 金币。"),
    ...
    --("zh_Hans_CN",  "LOC_CIVILIZATION_NAN_MADOL_BONUS",                  "您境内位于或与浅海与湖泊单元格相邻的区域（市中心外）和奇观+1 [ICON_CULTURE] 文化值。"),
    ...
    --("zh_Hans_CN",  "LOC_CIVILIZATION_BUENOS_AIRES_BONUS",               "每个基础相邻加成至少+9的区域为所在城市提供+9%对应产出。"),
