...
values
    ...
    ("LOC_BUILDING_HD_LANDFORM_EPO_DESCRIPTION",                  "+3 [ICON_SCIENCE] Science and +3 [ICON_CULTURE] Culture for every type of Feature within your empire (not including Natural Wonders). If you have every type of Feature inside your empire, this bonus is quadrupled. [NEWLINE][NEWLINE]Can only be built once in a civilization."),
    ("LOC_BUILDING_HD_RESOURCE_EPO_NAME",                         "Non-renewable Resources Administration Agency"),
    ("LOC_BUILDING_HD_RESOURCE_EPO_DESCRIPTION",                  "+2 [ICON_PRODUCTION] Production and +2 [ICON_SCIENCE] Science for every type of improved Minearl Resource within your empire. If you have every type of Mineral Resource inside your empire, this bonus is quadrupled. [NEWLINE][NEWLINE]Can only be built once in a civilization."),
    ("LOC_BUILDING_HD_SPECIES_EPO_NAME",                          "Species Diversity Conservation Agency"),
    ("LOC_BUILDING_HD_SPECIES_EPO_DESCRIPTION",                   "+2 [ICON_GOLD] Gold and +2 [ICON_CULTURE] Culture for every type of improved Biological Resource within your empire. If you have every type of Biological Resource inside your empire, this bonus is quadrupled. [NEWLINE][NEWLINE]Can only be built once in a civilization."),
...
values
    ...
    -- 社区
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_DESCRIPTION",                      "本城+10%余粮。玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%。[NEWLINE]以本城为目的地的国内 [ICON_TRADEROUTE] 贸易路线+2 [ICON_FOOD] 食物。该效果会在满足以下条件时分别翻倍：此城的商业中心基础相邻加成至少+9；玩家解锁“现代农业”科技。[NEWLINE][NEWLINE]文明中一次仅限建造一座该建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_DESCRIPTION_CORP",                 "本城+10%余粮。玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%。[NEWLINE]以本城为目的地的国内 [ICON_TRADEROUTE] 贸易路线+2 [ICON_FOOD] 食物。该效果会在满足以下条件时分别翻倍：此城的商业中心基础相邻加成至少+9；玩家解锁“现代农业”科技。[NEWLINE]6个单元格内的每个城市中 [ICON_GreatWork_Product] 产品产出2倍的 [ICON_FOOD] 食物和 [ICON_PRODUCTION] 生产力。[NEWLINE][NEWLINE]文明中一次仅限建造一座该建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_DESCRIPTION",                    "本城+10% [ICON_GOLD] 金币。玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%。[NEWLINE]以本城为目的地的国内 [ICON_TRADEROUTE] 贸易路线+6 [ICON_GOLD] 金币。该效果会在满足以下条件时分别翻倍：此城的商业中心基础相邻加成至少+9；玩家解锁“金融学”市政。[NEWLINE][NEWLINE]文明中一次仅限建造一座该建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_DESCRIPTION_CORP",               "本城+10% [ICON_GOLD] 金币。玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%。[NEWLINE]以本城为目的地的国内 [ICON_TRADEROUTE] 贸易路线+6 [ICON_GOLD] 金币。该效果会在满足以下条件时分别翻倍：此城的商业中心基础相邻加成至少+9；玩家解锁“金融学”市政。[NEWLINE]6个单元格内的每个城市中 [ICON_GreatWork_Product] 产品产出3倍的 [ICON_GOLD] 金币。[NEWLINE][NEWLINE]文明中一次仅限建造一座该建筑。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_RESOURCE_EPO_DESCRIPTION",                  "境内每开发一种矿产类资源，则获得+4 [ICON_PRODUCTION] 生产力、+4 [ICON_SCIENCE] 科技值。[NEWLINE][NEWLINE]文明中一次仅限建造一座该建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SPECIES_EPO_NAME",                          "物种多样性维护专局"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SPECIES_EPO_DESCRIPTION",                   "境内每收集一种生物类资源，则获得+4 [ICON_FOOD] 食物、+4 [ICON_CULTURE] 文化值。[NEWLINE][NEWLINE]文明中一次仅限建造一座该建筑。"),
