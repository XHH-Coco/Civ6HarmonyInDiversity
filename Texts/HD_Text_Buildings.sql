...
values
    ...
    ("LOC_BUILDING_NILOMETER_HD_DESCRIPTION",                     "+1 [ICON_Science] Science if the City Center is adjacent to Flood Plains, Oasis or {LOC_MARSH_OR_SWAMP}. After Geomatics is researched, provides an additional +1 [ICON_Science] Science. [NEWLINE][NEWLINE]May not be built in cities that already have a Triumphal Arch."),
    ("LOC_BUILDING_TRIUMPHAL_ARCH_NAME",                          "Triumphal Arch"),
    ("LOC_BUILDING_TRIUMPHAL_ARCH_DESCRIPTION",                   "+1 [ICON_Culture] Culture if this city has any World Wonder. After Heraldry is researched, provides an additional +1 [ICON_Culture] Culture. [NEWLINE][NEWLINE]May not be built in cities that already have a Nilometer."),
    ("LOC_BUILDING_KAREZ_NAME",                                   "Karez"),
    ("LOC_BUILDING_KAREZ_DESCRIPTION",                            "+1 [ICON_Food] Food if the City Center is on Hills or is adjacent to Mountains. After Geomatics is researched, provides an additional +1 [ICON_Production] Production. [NEWLINE][NEWLINE]May not be built in cities that already have a Pit dwelling."),
    ("LOC_BUILDING_OFFICIAL_RUN_HANDCRAFT_NAME",                  "Artisan Plaza"),
    ("LOC_BUILDING_OFFICIAL_RUN_HANDCRAFT_DESCRIPTION",           "Mines and Quarries over bonus resources in this City provide +1 [ICON_Production] Production. After Iron Working is researched, provides an additional +1 [ICON_Production] Production."),
    ("LOC_BUILDING_BOOTCAMP_NAME",                                "Boot Camp"),
    ("LOC_BUILDING_BOOTCAMP_DESCRIPTION",                         "+2 [ICON_Production] Production towards Units if the city owns Pastures or Camps over resources, or improved strategic resources."),
    ("LOC_BUILDING_FAIR_NAME",                                    "Fair"),
    ("LOC_BUILDING_FAIR_DESCRIPTION",                             "+6 [ICON_Gold] Gold if the City Center is locate on or adjacent to at least one Luxury resource. After Textile is researched, provides an additional +1 [ICON_Production] Production. [NEWLINE][NEWLINE]May not be built in cities that already have a River Dock."),
    ("LOC_BUILDING_TOTEMS_NAME",                                  "Totem"),
    ("LOC_BUILDING_TOTEMS_DESCRIPTION",                           "+2 [ICON_FAITH] Faith if the City Center is adjacent to Mountain, Woods, Rainforest or oceanic features. After Alchemy is researched, provides an additional +1 [ICON_SCIENCE] Science."),
    ("LOC_BUILDING_HD_CAMPFIRE_NAME",                             "Campfire"),
    ("LOC_BUILDING_HD_CAMPFIRE_DESCRIPTION",                      "Camps and Lumber Mills over bonus resources in this City provide +1 [ICON_Food] Food. After Charcoal Making is researched, provides an additional +1 [ICON_Production] Production."),
    ("LOC_BUILDING_HD_WHARF_RIVER_NAME",                          "River Dock"),
    ("LOC_BUILDING_HD_WHARF_RIVER_DESCRIPTION",                   "+6 [ICON_Gold] Gold if the city owns improved bonus resources on land. After Shipbuilding is researched, provides an additional +1 [ICON_Food] Food. [NEWLINE][NEWLINE]City must be adjacent to a River. May not be built in cities that already have a Fair."),
    ...
    ("LOC_BUILDING_WATER_MILL_DESCRIPTION",                       "After Engineering is researched, provides an additional +1 [ICON_Production] Production. Farm on bonus resource gain +1 [ICON_Production] Production. [NEWLINE][NEWLINE]City must be adjacent to a River. May not be built in cities that already have a Cellar."),
    ("LOC_BUILDING_FLOOD_BARRIER_NAME",                           "Seawall"),
    ("LOC_BUILDING_HD_PIT_DWELLING_NAME",                         "Pit dwelling"),
    ("LOC_BUILDING_HD_PIT_DWELLING_DESCRIPTION",                  "A building unique to Japan. +2 [ICON_Food] Food if this city owns improved Camps or Fishing Boats resources. Camps and Fishing Boats in this city provide +1 [ICON_Production] Production with Early Empire Civic. After Feudalism is researched, provides an additional +1 [ICON_Food] Food. [NEWLINE][NEWLINE]May not be built in cities that already have a Karez."),
    ("LOC_BUILDING_HD_PIT_DWELLING_COMMON_DESCRIPTION",           "+2 [ICON_Food] Food if this city owns improved Camps or Fishing Boats resources. After Feudalism is researched, provides an additional +1 [ICON_Food] Food. [NEWLINE][NEWLINE]May not be built in cities that already have a Karez."),
    ("LOC_BUILDING_HD_CELLAR_NAME",                               "Cellar"),
    ("LOC_BUILDING_HD_CELLAR_DESCRIPTION",                        "After Construction is researched, provides an additional +1 [ICON_Food] Food. Farm on bonus resource gain +1 [ICON_FOOD] Food. [NEWLINE][NEWLINE]May not be built in cities that already have a Water Mill."),
    ("LOC_BUILDING_PALGUM_DESCRIPTION",                           "A building unique to Babylon. Replaces Water Mill. +1 [ICON_HOUSING] Housing and +2 [ICON_PRODUCTION] Production. After Engineering is researched, provides an additional +1 [ICON_Production] Production. Freshwater tiles receive +1 [ICON_FOOD] Food. City must be adjacent to a River."),
    ("LOC_BUILDING_HD_ROYAL_COURT_NAME",                          "Royal Court"),
    ("LOC_BUILDING_HD_ROYAL_COURT_DESCRIPTION",                   "Must be built in [ICON_CAPITAL] Capital. +0.3 [ICON_Culture] Culture per [ICON_Citizen] Citizen in the [ICON_Capital] Capital. +0.3 [ICON_PRODUCTION] Production per [ICON_Citizen] Citizen in city with Government Plaza."),
    -- Campus
    ...
    ("LOC_BUILDING_SEOWON_DESCRIPTION",                           "Yi Do's Seowon can hold a [ICON_GreatWork_Writing] Great Work of Writing."),
    ("LOC_BUILDING_SEOWON_INTERNAL_ONLY_NAME",                    "Requires Leader is Yi Do"),
    ("LOC_BUILDING_HD_AGRICULTURE_COLLEGE_NAME",                  "Agriculture College"),
    ("LOC_BUILDING_HD_AGRICULTURE_COLLEGE_DESCRIPTION",           "This Campus receives [ICON_FOOD] Food equal to its adjacency bonus. [NEWLINE][ICON_CITIZEN] Citizens in this city provide +1 [ICON_SCIENCE] Science. This bonus is respectively doubled when the following conditions are met: this City is fully [ICON_POWER] Powered; Genetic Engineering is researched."),
    ("LOC_BUILDING_HD_AGRICULTURE_COLLEGE_NAME_C",                "Medical College"),
    ("LOC_BUILDING_HD_AGRICULTURE_COLLEGE_DESCRIPTION_C",         "+20% Growth rate in this city. [NEWLINE][ICON_CITIZEN] Citizens in this city provide +1 [ICON_SCIENCE] Science. This bonus is respectively doubled when the following conditions are met: this City is fully [ICON_POWER] Powered; Genetic Engineering is researched."),
    ("LOC_BUILDING_HD_FINANCE_COLLEGE_NAME",                      "Finance College"),
    ("LOC_BUILDING_HD_FINANCE_COLLEGE_DESCRIPTION",               "Bonus [ICON_GOLD] Gold equal to the adjacency bonus of the Campus district. Commercial Hub and Harbor districts in this city receives [ICON_Science] Science equal to its adjacency bonus."),
    ...
    ("LOC_BUILDING_HD_INTERNET_COMPANY_MONOPOLY_DESCRIPTION",     "Campus and Industrial Zone district's adjacency bonus provides [ICON_TOURISM] Tourism as well. +100% Yields and [ICON_TOURISM] Tourism to [ICON_Greatwork_Product] Products in this City. +5% [ICON_TOURISM] Tourism across your empire when city is powered."),
    ...
    ("LOC_BUILDING_GOV_FAITH_HD_DESCRIPTION",                     "Receive [ICON_Science] Science and [ICON_Culture] Culture equal to 10% of your [ICON_Faith] Faith output in all cities.[NEWLINE]Religious units are 20% cheaper to purchase in all cities. +5 [ICON_Religion] Religious Strength in Theological Combat.[NEWLINE]+8 [ICON_Faith] Faith for each foreign city following your Religion.[NEWLINE]Awards +1 [ICON_Governor] Governor Title."),
    ...
    ("LOC_BUILDING_EL_ESCORIAL_PALACE_DESCRIPTION",               "A building unique to Philip II. Yield bonus of Palace and this building equal to the basic yield bonus or adjacency yield bonus of all natural wonders discovered by your units. Each new natural wonder discovered by your units provides +2 [ICON_GreatProphet] Great Prophet points, +2 [ICON_GreatWriter] Great Writer points and +2 [ICON_GreatArtist] Great Artist points per turn. +50% [ICON_CULTURE] Culture and [ICON_Faith] Faith to [ICON_GreatWork_Relic] Great Work of Relic, [ICON_GreatWork_Writing] Great Work of Writing and [ICON_GreatWork_Landscape] Great Work of Art."),
    -- Diplomatic Quarter
    ...
    ("LOC_BUILDING_ZOO_EXPANSION1_DESCRIPTION",                   "+1 [ICON_Food] Food, +1 [ICON_Culture] Culture and +3 [ICON_Gold] Gold from every type of improved Camp or Pasture Resource within your empire. +6 [ICON_Gold] Gold to Camps and Pastures in this city; doubled after Biology is researched."),
    ...
    ("LOC_BUILDING_HD_CIRCUS_NAME",                               "Circus"),
    ("LOC_BUILDING_HD_CIRCUS_DESCRIPTION",                        "Provide corresponding yield from each type of adjacent districts to all Cities within 6 tiles from Circus that do not already have a bonus from another Circus."),
    ("LOC_BUILDING_HD_JEWELRY_SHOP_NAME",                         "Jewelry Shop"),
    ("LOC_BUILDING_HD_JEWELRY_SHOP_DESCRIPTION",                  "+1 [ICON_PRODUCTION] Production, +1 [ICON_Culture] Culture and +3 [ICON_Gold] Gold from every type of improved Mine or Quarry Resource within your empire. +6 [ICON_Gold] Gold to Mines and Quarries in this city; doubled after Macroeconomics is researched."),
    ...
    ("LOC_BUILDING_AQUARIUM_DL_DESCRIPTION",                      "+1 [ICON_Food] Food, +1 [ICON_SCIENCE] Science and +3 [ICON_Gold] Gold from every type of improved Fishing Boat Resource within your empire. +6 [ICON_Gold] Gold to Fishing Boats and Fisheries in this city; doubled after Biology is researched."),
    -- Aerodrome
    ...
    -- Neighborhood.
    ("LOC_BUILDING_FOOD_MARKET_DESCRIPTION",                      "+10% growth rate. +10% accumulation rate for [ICON_GREATMERCHANT] Great Merchant Points. [NEWLINE]+2 [ICON_FOOD] Food for Domestic [ICON_TRADEROUTE] Trade Route to this City. This bonus is respectively doubled when the following conditions are met: Commercial Hub in this city has at least +9 adjacency bonus; Modern Agriculture is researched."),
    ("LOC_BUILDING_FOOD_MARKET_DESCRIPTION_CORP",                 "+10% growth rate. +10% accumulation rate for [ICON_GREATMERCHANT] Great Merchant Points. [NEWLINE]+2 [ICON_FOOD] Food for Domestic [ICON_TRADEROUTE] Trade Route to this City. This bonus is respectively doubled when the following conditions are met: Commercial Hub in this city has at least +9 adjacency bonus; Modern Agriculture is researched. [NEWLINE]All [ICON_GreatWork_Product] Products in the city yields twice as much [ICON_FOOD] Food and [ICON_PRODUCTION] Production. This bonus is extended to city centers within a six-tile radius from the Shopping Mall, as long as they do not have the same bonus from another Food Market."),
    ("LOC_BUILDING_SHOPPING_MALL_DESCRIPTION",                    "+10% [ICON_GOLD] Gold. +10% accumulation rate for [ICON_GREATMERCHANT] Great Merchant Points. [NEWLINE]+6 [ICON_GOLD] Gold for Domestic [ICON_TRADEROUTE] Trade Route to this City. This bonus is respectively doubled when the following conditions are met: Commercial Hub in this city has at least +9 adjacency bonus; Finance is researched."),
    ("LOC_BUILDING_SHOPPING_MALL_DESCRIPTION_CORP",               "+10% [ICON_GOLD] Gold. +10% accumulation rate for [ICON_GREATMERCHANT] Great Merchant Points. [NEWLINE]+6 [ICON_GOLD] Gold for Domestic [ICON_TRADEROUTE] Trade Route to this City. This bonus is respectively doubled when the following conditions are met: Commercial Hub in this city has at least +9 adjacency bonus; Finance is researched. [NEWLINE]All [ICON_GreatWork_Product] Products in the city yields thrice as much [ICON_gold] Gold. This bonus is extended to city centers within a six-tile radius from the Shopping Mall, as long as they do not have the same bonus from another Shopping Mall."),
    ("LOC_BUILDING_HD_ANCESTRAL_TEMPLE_NAME",                     "Ancestral Temple"),
    ("LOC_BUILDING_HD_ANCESTRAL_TEMPLE_DESCRIPTION",              "+3 [ICON_Faith] Faith to Neighborhood in this city. +10% Growth rate in this city if this city has Totem."),
    ("LOC_BUILDING_HD_TAVERN_NAME",                               "Tavern"),
    ("LOC_BUILDING_HD_TAVERN_DESCRIPTION",                        "+2 [ICON_Food] Food to Neighborhood in this city. +4 [ICON_GREATARTIST] Great Artist points per turn if this city has Cellar."),
    ("LOC_BUILDING_HD_INN_NAME",                                  "Inn"),
    ("LOC_BUILDING_HD_INN_DESCRIPTION",                           "+1 [ICON_SCIENCE] Science and +3 [ICON_GOLD] Gold to Neighborhood in this city. +4 [ICON_GREATWRITER] Great Writer points per turn if this city has Water Mill."),
    ("LOC_BUILDING_HD_DRAMA_STAGE_NAME",                          "Drama Stage"),
    ("LOC_BUILDING_HD_DRAMA_STAGE_DESCRIPTION",                   "+1 [ICON_CULTURE] Culture and +3 [ICON_GOLD] Gold to Neighborhood in this city. +4 [ICON_GREATMUSICIAN] Great Musician points per turn if this city has Granary."),
    ("LOC_BUILDING_HD_LOCAL_POLICE_STATION_NAME",                 "Local Police Station"),
    ("LOC_BUILDING_HD_LOCAL_POLICE_STATION_DESCRIPTION",          "Receive corresponding yield of two copies from each type of adjacent districts and each type of districts in this city. [NEWLINE][NEWLINE]May not be built in cities that already have a Police Station."),
    ("LOC_BUILDING_HD_POLICE_STATION_NAME",                       "Police Station"),
    ("LOC_BUILDING_HD_POLICE_STATION_DESCRIPTION",                "Receive corresponding yield of two copies from each type of adjacent districts and each type of districts in this city. [NEWLINE][NEWLINE]May not be built in cities that already have a Local Police Station."),
    ("LOC_BUILDING_HD_MANSION_NAME",                              "Official Mansion"),
    ("LOC_BUILDING_HD_MANSION_DESCRIPTION",                       "Must be built in [ICON_CAPITAL] Capital. Cities with a [ICON_GOVERNOR] Governor and Neighborhood distirct can receive an extra basic regional yield from Buildings and Wonders. [NEWLINE]Awards +1 [ICON_Governor] Governor Title. [NEWLINE]Can only be built once in a civilization."),
    ("LOC_BUILDING_HD_BUS_STOP_NAME",                             "Bus Stop"),
    ("LOC_BUILDING_HD_BUS_STOP_DESCRIPTION",                      "+6 [ICON_GOLD] Gold to adjacent districts. +50% Commercial Hub and Harbor district adjacency bonuses in this city."),
    ("LOC_BUILDING_HD_NEWSPAPER_OFFICE_NAME",                     "Newspaper Office"),
    ("LOC_BUILDING_HD_NEWSPAPER_OFFICE_DESCRIPTION",              "[ICON_CITIZEN] Citizens in this city provide +0.5 [ICON_CULTURE] Culture, doubled if has at least 3 specialty districts. +50% [ICON_TOURISM] Tourism for [ICON_GreatWork_Writing] Great Works of Writing in this city."),
    ("LOC_BUILDING_HD_LAW_OFFICE_NAME",                           "Law Office"),
    -- ("LOC_BUILDING_HD_LAW_OFFICE_DESCRIPTION",                    "+1 [ICON_PRODUCTION] Production from each used Military policy."),
    -- Dam
    ...
    ("LOC_BUILDING_HD_WETLANDS_PRESERVE_NAME",                    "Wetlands Conservation Department"),
    ...
    ("LOC_BUILDING_HD_CULTURE_HERITAGE_PRESERVE_DESCRIPTION",     "+1 [ICON_CULTURE] Culture and +2 [ICON_GOLD] Gold to World Wonder or Unique Improvement tiles with Charming Appeal in this city, doubled if these tiles have Breathtaking Appeal. +100% Tourism from World Wonders and Unique Improvements in this city.[NEWLINE][NEWLINE]Can only be built on tiles adjacent to World Wonder or Unique Improvement tiles."),
    ("LOC_BUILDING_HD_LANDFORM_EPO_NAME",                         "Landscape Ecology Protection Agency"),
    ("LOC_BUILDING_HD_LANDFORM_EPO_DESCRIPTION",                  "+3 [ICON_SCIENCE] Science and +3 [ICON_CULTURE] Culture for every type of Feature within your empire (not including Natural Wonders). If you have every type of Feature inside your empire, this bonus is quadrupled. [NEWLINE]Can only be built once in a civilization."),
    ("LOC_BUILDING_HD_RESOURCE_EPO_NAME",                         "Non-renewable Resources Administration Agency"),
    ("LOC_BUILDING_HD_RESOURCE_EPO_DESCRIPTION",                  "+2 [ICON_PRODUCTION] Production and +2 [ICON_SCIENCE] Science for every type of improved Minearl Resource within your empire. If you have every type of Mineral Resource inside your empire, this bonus is quadrupled. [NEWLINE]Can only be built once in a civilization."),
    ("LOC_BUILDING_HD_SPECIES_EPO_NAME",                          "Species Diversity Conservation Agency"),
    ("LOC_BUILDING_HD_SPECIES_EPO_DESCRIPTION",                   "+2 [ICON_GOLD] Gold and +2 [ICON_CULTURE] Culture for every type of improved Biological Resource within your empire. If you have every type of Biological Resource inside your empire, this bonus is quadrupled. [NEWLINE]Can only be built once in a civilization."),
    ("LOC_BUILDING_HD_SCENIC_EPO_NAME",                           "Natural Attractions Tourism Agency"),
    ("LOC_BUILDING_HD_SCENIC_EPO_DESCRIPTION",                    "Triples the yield of Natural Wonders across your empire. +5% all yields in cities with a Natural Wonder or a National Park, quadrupled if you have every Natural Wonder inside your empire. Immediately gain a Naturalist. Naturalists are 50% cheaper to purchase with Faith. [NEWLINE]Can only be built once in a civilization."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_GRANARY_DESCRIPTION",                          "本城改良加成资源的种植园和牧场+1 [ICON_Food] 食物。解锁“历法”科技后，本城每位 [ICON_Citizen] 市民消耗的 [ICON_Food] 食物减少0.5。"),
    ("zh_Hans_CN",  "LOC_BUILDING_NILOMETER_HD_NAME",                            "测量仪"),
    ("zh_Hans_CN",  "LOC_BUILDING_NILOMETER_HD_DESCRIPTION",                     "如果市中心靠近泛滥平原、绿洲或{LOC_MARSH_OR_SWAMP}，则额外+1 [ICON_Science] 科技值。解锁“测绘学”科技后，测量仪额外+1 [ICON_Science] 科技值。[NEWLINE][NEWLINE]无法建造在已有凯旋门的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_TRIUMPHAL_ARCH_NAME",                          "凯旋门"),
    ("zh_Hans_CN",  "LOC_BUILDING_TRIUMPHAL_ARCH_DESCRIPTION",                   "如果城市中拥有至少1个世界奇观，则额外+1 [ICON_Culture] 文化值。解锁“纹章学”市政后，凯旋门额外+1 [ICON_Culture] 文化值。[NEWLINE][NEWLINE]无法建造在已有测量仪的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_KAREZ_NAME",                                   "坎儿井"),
    ("zh_Hans_CN",  "LOC_BUILDING_KAREZ_DESCRIPTION",                            "如果市中心位于丘陵之上或靠近山脉则额外+1 [ICON_Food] 食物。解锁“测绘学”科技后，坎儿井额外+1 [ICON_Production] 生产力。[NEWLINE][NEWLINE]无法建造在已有竖穴坑居的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_OFFICIAL_RUN_HANDCRAFT_NAME",                  "工官"),
    ("zh_Hans_CN",  "LOC_BUILDING_OFFICIAL_RUN_HANDCRAFT_DESCRIPTION",           "本城改良加成资源的矿山和采石场+1 [ICON_Production] 生产力。解锁“炼铁术”科技后，工官额外+1 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_BUILDING_BOOTCAMP_NAME",                                "训练营"),
    ("zh_Hans_CN",  "LOC_BUILDING_BOOTCAMP_DESCRIPTION",                         "如果城市拥有改良的战略、牧场或营地资源，则建造单位时+2 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_BUILDING_FAIR_NAME",                                    "集市"),
    ("zh_Hans_CN",  "LOC_BUILDING_FAIR_DESCRIPTION",                             "如果市中心拥有或与至少一个奢侈资源相邻，则额外+6 [ICON_Gold] 金币。解锁“纺织”科技后，集市额外+1 [ICON_Production] 生产力。[NEWLINE][NEWLINE]无法建造在已有河运港市的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_TOTEMS_NAME",                                  "图腾柱"),
    ("zh_Hans_CN",  "LOC_BUILDING_TOTEMS_DESCRIPTION",                           "如果市中心与山脉、森林、雨林或海洋地貌相邻，则额外+2 [ICON_FAITH] 信仰值。解锁“炼丹术”科技后，图腾柱额外+1 [ICON_Science] 科技值。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CAMPFIRE_NAME",                             "营火"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CAMPFIRE_DESCRIPTION",                      "本城改良加成资源的营地和伐木场+1 [ICON_Food] 食物。解锁“制炭”科技后，营火额外+1 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_WHARF_RIVER_NAME",                          "河运港市"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_WHARF_RIVER_DESCRIPTION",                   "如果城市拥有改良的陆地加成资源，则额外+6 [ICON_Gold] 金币。解锁“造船术”科技后，河运港市额外+1 [ICON_Food] 食物。[NEWLINE][NEWLINE]城市必须与河流相邻。无法建造在已有集市的城市中。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_WATER_MILL_DESCRIPTION",                       "本城改良加成资源的农场+1 [ICON_Production] 生产力。解锁“工程”科技后，水磨额外+1 [ICON_Production] 生产力。[NEWLINE][NEWLINE]城市必须与河流相邻。无法建造在已有酒窖的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_FLOOD_BARRIER_NAME",                           "拦海堤"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_PIT_DWELLING_NAME",                         "竖穴坑居"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_PIT_DWELLING_DESCRIPTION",                  "日本特色建筑。如果城市拥有改良的营地或渔船资源，则额外+2 [ICON_Food] 食物。解锁“帝国初期”市政后本城的营地和渔船 +1 [ICON_Production] 生产力。解锁“封建主义”市政后，则额外+1 [ICON_Food] 食物。[NEWLINE][NEWLINE]无法建造在已有坎儿井的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_PIT_DWELLING_COMMON_DESCRIPTION",           "如果城市拥有改良的营地或渔船资源，则额外+2 [ICON_Food] 食物。解锁“封建主义”市政后，竖穴坑居额外+1 [ICON_Food] 食物。[NEWLINE][NEWLINE]无法建造在已有坎儿井的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CELLAR_NAME",                               "酒窖"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CELLAR_DESCRIPTION",                        "本城改良加成资源的农场+1 [ICON_FOOD] 食物。解锁“建造”科技后，酒窖额外+1 [ICON_FOOD] 食物。[NEWLINE][NEWLINE]无法建造在已有水磨的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_PALGUM_DESCRIPTION",                           "巴比伦特色建筑。本城淡水单元格+1 [ICON_FOOD] 食物。解锁“工程”科技后，沟渠额外+1 [ICON_Production] 生产力。[NEWLINE][NEWLINE]城市必须建在河流旁。无法建造在已有酒窖的城市中。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_SEOWON_DESCRIPTION",                           "李裪的书院额外+1 [ICON_GreatWork_Writing] 著作槽位。"),
    ("zh_Hans_CN",  "LOC_BUILDING_SEOWON_INTERNAL_ONLY_NAME",                    "领袖为李裪"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_AGRICULTURE_COLLEGE_NAME",                  "农业学院"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_AGRICULTURE_COLLEGE_DESCRIPTION",           "此学院获得等于相邻加成的 [ICON_FOOD] 食物加成。[NEWLINE]每位 [ICON_CITIZEN] 公民+1 [ICON_Science] 科技值。该效果会在满足以下条件时分别翻倍：此城 [ICON_POWER] 供电充足；玩家解锁“基因工程”科技。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_AGRICULTURE_COLLEGE_NAME_C",                "医学院"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_AGRICULTURE_COLLEGE_DESCRIPTION_C",         "本城+20%余粮。[NEWLINE]每位 [ICON_CITIZEN] 公民+1 [ICON_Science] 科技值。该效果会在满足以下条件时分别翻倍：此城 [ICON_POWER] 供电充足；玩家解锁“基因工程”科技。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_FINANCE_COLLEGE_NAME",                      "财经学院"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_FINANCE_COLLEGE_DESCRIPTION",               "[ICON_GOLD] 金币加成等于学院区域的相邻加成。此城市的商业中心和港口区域相邻加成也提供 [ICON_Science] 科技值产出。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_INTERNET_COMPANY_MONOPOLY_DESCRIPTION",     "学院和工业区的相邻加成也产生等量 [ICON_Tourism] 旅游业绩。此城市的 [ICON_GreatWork_Product] 产品提供2倍产出，且提供的 [ICON_Tourism] 旅游业绩+100%。此城 [ICON_POWER] 供电充足时，全境内+5% [ICON_TOURISM] 旅游业绩。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_GOV_FAITH_HD_DESCRIPTION",                     "每座信奉你创立的宗教的外国城市为你提供+8 [ICON_Faith] 信仰值。所有城市获得等同于 [ICON_Faith] 信仰值产出10%的 [ICON_Science] 科技值和 [ICON_Culture] 文化值。所有城市购买宗教单位的花费减少20%。宗教单位在神学战斗中+5 [ICON_Religion] 宗教力量。[NEWLINE]奖励1个 [ICON_Governor] 总督头衔。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_ZOO_EXPANSION1_DESCRIPTION",                   "境内每拥有一种改良的牧场或营地资源，动物园额外+1 [ICON_FOOD] 食物，+1 [ICON_CULTURE] 文化值，+3 [ICON_GOLD] 金币。此城的牧场和营地+6 [ICON_Gold] 金币，解锁“生物”科技后收益翻倍。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CIRCUS_NAME",                               "马戏团"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CIRCUS_DESCRIPTION",                        "相邻的每种区域为距离马戏团6个单元格内的城市提供对应产出（前提是其尚未从其他的“马戏团”建筑获得加成）。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_JEWELRY_SHOP_NAME",                         "珠宝行"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_JEWELRY_SHOP_DESCRIPTION",                  "境内每拥有一种改良的矿山或采石场资源，珠宝行额外+1 [ICON_PRODUCTION] 生产力，+1 [ICON_CULTURE] 文化值，+3 [ICON_GOLD] 金币。此城的矿山和采石场+6 [ICON_Gold] 金币，解锁“宏观经济学”市政后收益翻倍。"),
    -- 水上娱乐
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_AQUARIUM_DL_DESCRIPTION",                      "境内每拥有一种改良的渔船资源，水族馆额外+1 [ICON_FOOD] 食物，+1 [ICON_SCIENCE] 科技值，+3 [ICON_GOLD] 金币。此城的渔船和渔场+6 [ICON_Gold] 金币，解锁“生物”科技后收益翻倍。"),
    -- 航空港
    ...
    -- 社区
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_DESCRIPTION",                      "本城+10%余粮。玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%。[NEWLINE]以本城为目的地的国内 [ICON_TRADEROUTE] 贸易路线+2 [ICON_FOOD] 食物。该效果会在满足以下条件时分别翻倍：此城的商业中心基础相邻加成至少+9；玩家解锁“现代农业”科技。"),
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_DESCRIPTION_CORP",                 "本城+10%余粮。玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%。[NEWLINE]以本城为目的地的国内 [ICON_TRADEROUTE] 贸易路线+2 [ICON_FOOD] 食物。该效果会在满足以下条件时分别翻倍：此城的商业中心基础相邻加成至少+9；玩家解锁“现代农业”科技。[NEWLINE]6个单元格内的每个城市中 [ICON_GreatWork_Product] 产品产出2倍的 [ICON_FOOD] 食物和 [ICON_PRODUCTION] 生产力（前提是其尚未从其他的“食品市场”建筑获得加成）。"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_DESCRIPTION",                    "本城+10% [ICON_GOLD] 金币。玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%。[NEWLINE]以本城为目的地的国内 [ICON_TRADEROUTE] 贸易路线+6 [ICON_GOLD] 金币。该效果会在满足以下条件时分别翻倍：此城的商业中心基础相邻加成至少+9；玩家解锁“金融学”市政。"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_DESCRIPTION_CORP",               "本城+10% [ICON_GOLD] 金币。玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%。[NEWLINE]以本城为目的地的国内 [ICON_TRADEROUTE] 贸易路线+6 [ICON_GOLD] 金币。该效果会在满足以下条件时分别翻倍：此城的商业中心基础相邻加成至少+9；玩家解锁“金融学”市政。[NEWLINE]6个单元格内的每个城市中 [ICON_GreatWork_Product] 产品产出3倍的 [ICON_GOLD] 金币（前提是其尚未从其他的“购物商场”建筑获得加成）。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_ANCESTRAL_TEMPLE_NAME",                     "宗祠"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_ANCESTRAL_TEMPLE_DESCRIPTION",              "本城的社区+3 [ICON_FAITH] 信仰值。本城有图腾柱则+10%余粮。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_TAVERN_NAME",                               "酒楼"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_TAVERN_DESCRIPTION",                        "本城的社区+2 [ICON_FOOD] 食物。本城有酒窖则每回合+4 [ICON_GREATARTIST] 大艺术家点数。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_INN_NAME",                                  "客栈"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_INN_DESCRIPTION",                           "本城的社区+1 [ICON_SCIENCE] 科技值，+3 [ICON_GOLD] 金币。本城有水磨则每回合+4 [ICON_GREATWRITER] 大作家点数。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DRAMA_STAGE_NAME",                          "戏台"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DRAMA_STAGE_DESCRIPTION",                   "本城的社区+1 [ICON_CULTURE] 文化值，+3 [ICON_GOLD] 金币。本城有粮仓则每回合+4 [ICON_GREATMUSICIAN] 大音乐家点数。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_LOCAL_POLICE_STATION_NAME",                 "派出所"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_LOCAL_POLICE_STATION_DESCRIPTION",          "从本城的每个区域和相邻的每个区域分别获得2份对应产出。[NEWLINE][NEWLINE]无法建造在已有警署的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_POLICE_STATION_NAME",                       "警署"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_POLICE_STATION_DESCRIPTION",                "从本城的每个区域和相邻的每个区域分别获得2份对应产出。[NEWLINE][NEWLINE]无法建造在已有派出所的城市中。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_MANSION_NAME",                              "官邸"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_MANSION_DESCRIPTION",                       "必须建造在 [ICON_CAPITAL] 首都。有 [ICON_GOVERNOR] 总督就职且有社区的城市可以从建筑和奇观获得一份额外的基础辐射产出。[NEWLINE]奖励1个 [ICON_GOVERNOR] 总督头衔。[NEWLINE]文明中一次仅限建造一座该建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_BUS_STOP_NAME",                             "公交站"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_BUS_STOP_DESCRIPTION",                      "相邻的区域+6 [ICON_GOLD] 金币。本城的商业中心和港口+50%相邻加成。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_NEWSPAPER_OFFICE_NAME",                     "报社"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_NEWSPAPER_OFFICE_DESCRIPTION",              "每位 [ICON_CITIZEN] 市民+0.5 [ICON_CULTURE] 文化值，若拥有至少3个专业化区域则收益翻倍。本城所有 [ICON_GreatWork_Writing] 著作+50% [ICON_TOURISM] 旅游业绩。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_LAW_OFFICE_NAME",                           "律所"),
    -- ("zh_Hans_CN",  "LOC_BUILDING_HD_LAW_OFFICE_DESCRIPTION",                    "每使用过一个不同的军事政策+1 [ICON_PRODUCTION] 生产力。"),
    -- 堤坝
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CULTURE_HERITAGE_PRESERVE_DESCRIPTION",     "本城位于迷人单元格的世界奇观和特色改良设施+1 [ICON_CULTURE] 文化值、+2 [ICON_GOLD] 金币；若位于惊艳单元格，则收益翻倍。本城的世界奇观和特色改良设施提供的 [ICON_TOURISM] 旅游业绩+100%。[NEWLINE][NEWLINE]只能建造在相邻世界奇观或特色改良设施的单元格上。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_LANDFORM_EPO_NAME",                         "地貌生态环保专局"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_LANDFORM_EPO_DESCRIPTION",                  "境内每拥有一种地貌（不包括自然奇观），则获得+8 [ICON_SCIENCE] 科技值、+8 [ICON_CULTURE] 文化值。[NEWLINE]文明中一次仅限建造一座该建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_RESOURCE_EPO_NAME",                         "不可再生资源管理专局"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_RESOURCE_EPO_DESCRIPTION",                  "境内每开发一种矿产资源，则获得+4 [ICON_PRODUCTION] 生产力、+4 [ICON_SCIENCE] 科技值。[NEWLINE]文明中一次仅限建造一座该建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SPECIES_EPO_NAME",                          "物种多样性维护专局"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SPECIES_EPO_DESCRIPTION",                   "境内每收集一种生物资源，则获得+4 [ICON_FOOD] 食物、+4 [ICON_CULTURE] 文化值。[NEWLINE]文明中一次仅限建造一座该建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SCENIC_EPO_NAME",                           "自然名胜旅游专局"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SCENIC_EPO_DESCRIPTION",                    "境内的自然奇观提供的产出翻三倍。拥有自然奇观或国家公园的城市+5%所有产出。国家公园提供的 [ICON_TOURISM] 旅游业绩+100%。建成时获得1个自然学家。购买自然学家的费用降低50%。[NEWLINE]文明中一次仅限建造一座该建筑。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_HERITAGE_PRESERVE_NAME",              "保护区拥有一级建筑，且相邻世界奇观或特色改良设施"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_HERITAGE_PRESERVE_DESCRIPTION",       "该城的保护区相邻世界奇观、特色改良设施，且拥有一级建筑。"),
    -- 主题化
