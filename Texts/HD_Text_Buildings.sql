...
values
    ...
    ("LOC_BUILDING_FOOD_MARKET_DESCRIPTION",                      "+10% accumulation rate for {LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT} Points, this bonus is doubled after Modern Agriculture is researched. +3 [ICON_GOLD] Gold from each type of Crops, Cuisine, Fruit, Brewing, Beverage, Oil, Seasoning or Seafood Resource you controlled. "),
    ("LOC_BUILDING_FOOD_MARKET_DESCRIPTION_CORP",                 "+10% accumulation rate for {LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT} Points, this bonus is doubled after Modern Agriculture is researched. +3 [ICON_GOLD] Gold from each type of Crops, Cuisine, Fruit, Brewing, Beverage, Oil, Seasoning or Seafood Resource you controlled. [NEWLINE][NEWLINE]When the city is [ICON_POWER] powered, +50% [ICON_FOOD] Food and [ICON_PRODUCTION] Production and +100% [ICON_TOURISM] Tourism from [ICON_GreatWork_Product] Products in this city."),
    ("LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT",                      "[ICON_GREATMERCHANT] Great Merchant"),
    ("LOC_BUILDING_SHOPPING_MALL_NAME",                           "Department Store"),
    ("LOC_BUILDING_SHOPPING_MALL_DESCRIPTION",                    "+10% accumulation rate for [ICON_GREATMERCHANT] Great Merchant Points, this bonus is doubled after Finance is researched. +3 [ICON_GOLD] Gold from each type of Leather, Cloth, Marine Products, Medicine, Stationery, Art, Decoration or Household Resource you controlled. "),
    ("LOC_BUILDING_SHOPPING_MALL_DESCRIPTION_CORP",               "+10% accumulation rate for [ICON_GREATMERCHANT] Great Merchant Points, this bonus is doubled after Finance is researched. +3 [ICON_GOLD] Gold from each type of Leather, Cloth, Marine Products, Medicine, Stationery, Art, Decoration or Household Resource you controlled. [NEWLINE][NEWLINE]When the city is [ICON_POWER] powered, +50% [ICON_Gold] Gold and [ICON_Faith] Faith and +100% [ICON_TOURISM] Tourism from [ICON_GreatWork_Product] Products in this city."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_DESCRIPTION",                      "玩家的{LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT}点数积累速度+10%，解锁“现代农业”科技后翻倍。你每拥有一种庄稼、美食、水果、酿造、饮料、油料、调料或海鲜资源，+3 [ICON_GOLD] 金币。"),
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_DESCRIPTION_CORP",                 "玩家的{LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT}点数积累速度+10%，解锁“现代农业”科技后翻倍。你每拥有一种庄稼、美食、水果、酿造、饮料、油料、调料或海鲜资源，+3 [ICON_GOLD] 金币。[NEWLINE][NEWLINE]若 [ICON_POWER] 供电充足，本城的 [ICON_GreatWork_Product] 产品提供1.5倍的 [ICON_FOOD] 食物和 [ICON_PRODUCTION] 生产力，且 [ICON_TOURISM] 旅游业绩+100%。"),
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT",                      " [ICON_GREATMERCHANT] 大商人"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_NAME",                           "百货大楼"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_DESCRIPTION",                    "玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%，解锁“金融学”市政后翻倍。你每拥有一种皮革、服装、海货、医药、文具、艺术、饰品或家居资源，+3 [ICON_GOLD] 金币。"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_DESCRIPTION_CORP",               "玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%，解锁“金融学”市政后翻倍。你每拥有一种皮革、服装、海货、医药、文具、艺术、饰品或家居资源，+3 [ICON_GOLD] 金币。[NEWLINE][NEWLINE]若 [ICON_POWER] 供电充足，本城的 [ICON_GreatWork_Product] 产品提供1.5倍的 [ICON_Gold] 金币和 [ICON_Faith] 信仰，且 [ICON_TOURISM] 旅游业绩+100%。"),
