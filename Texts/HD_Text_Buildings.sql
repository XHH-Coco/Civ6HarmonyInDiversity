...
values
    ...
    ("LOC_BUILDING_WALLS_HD_DESCRIPTION",                         "Provides Walls around the City Center and Encampment district. Walls allow [ICON_RANGED] Ranged Strikes from the City Center and Encampment district, and must be defeated before a city can be assaulted."),
    ("LOC_BUILDING_CASTLE_HD_DESCRIPTION",                        "Increases the strength of your outer defenses. This city is not affected by Battering Rams."),
    ("LOC_BUILDING_STAR_FORT_HD_DESCRIPTION",                     "Raises the strength of your outer defenses to the highest possible level. This city is not affected by Siege Towers or Battering Rams."),
    ...
    ("LOC_BUILDING_TSIKHE_DESCRIPTION_XP2",                       "A building unique to Georgia. Lower [ICON_Production] Production cost and higher outer defenses than Medieval Walls it replaces. Provides +4 [ICON_Faith] Faith. When in a Golden Age, extra +12 [ICON_FAITH] Faith."),
    ...
    ("LOC_BUILDING_HD_TABLES_OF_LAW_NAME",                        "Tables of Law"),
    ("LOC_BUILDING_HD_TABLES_OF_LAW_DESCRIPTION",                 "+0.3 [ICON_CULTURE] Culture per [ICON_CITIZEN] Citizen in the [ICON_CAPITAL] Capital. +0.3 [ICON_PRODUCTION] Production per [ICON_CITIZEN] Citizen in city with Government Plaza.[NEWLINE][NEWLINE]Must be built in [ICON_CAPITAL] Capital."),
    ...
    ("LOC_BUILDING_HD_ALCHEMY_ROOM_DESCRIPTION",                  "If city has improved Metallurgy or Medicine Resources, +3 [ICON_SCIENCE] Science and +6 [ICON_FAITH] Faith. Allows the purchasing of Settlers using [ICON_FAITH] Faith. Allows the purchasing of Apostles, Gurus, Inquisitors, and with the proper belief, Warrior Monks (these units can only be purchased with [ICON_FAITH] Faith)."),
    -- Encampment
    ...
    ("LOC_BUILDING_EL_ESCORIAL_PALACE_DESCRIPTION",               "A building unique to Philip II. Each time you discover a Natural Wonder, provide the basic yields or adjacency yields of this natural wonder to your Palace and this building, and provide +2 [ICON_GreatProphet] Great Prophet points, +2 [ICON_GreatWriter] Great Writer points and +2 [ICON_GreatArtist] Great Artist points per turn to this building. +50% [ICON_CULTURE] Culture and [ICON_Faith] Faith to [ICON_GreatWork_Relic] Great Work of Relic, [ICON_GreatWork_Writing] Great Work of Writing and [ICON_GreatWork_Landscape] Great Work of Art."),
    -- Diplomatic Quarter
    ...
    ("LOC_BUILDING_ARENA_HD_DESCRIPTION",                         "If you have at least 3 Leather or Beast Resources, +1 [ICON_Culture] Culture for regional yield and +1 regional range tile."),
    ("LOC_BUILDING_TLACHTLI_HD_DESCRIPTION",                      "A building unique to the Aztecs. If you have at least 3 Celebration or Household Resources, +1 [ICON_Culture] Culture and [ICON_FAITH] Faith for regional yield and +1 regional range tile."),
    ...
    ("LOC_BUILDING_AQUARIUM_DL_DESCRIPTION",                      "+2 [ICON_SCIENCE] Science from every type of Seafood or Marine Products Resource you controlled. +6 [ICON_Culture] Culture from every type of Sea Beast Resource you controlled."),
    -- Aerodrome
    ...
    ("LOC_BUILDING_FOOD_MARKET_DESCRIPTION",                      "+10% accumulation rate for {LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT} Points, this bonus is doubled after Modern Agriculture is researched. +3 [ICON_GOLD] Gold from each type of Crops, Cuisine, Fruit, Vegetable, Brewing, Beverage, Oil, Seasoning or Seafood Resource you controlled. "),
    ("LOC_BUILDING_FOOD_MARKET_DESCRIPTION_CORP",                 "+10% accumulation rate for {LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT} Points, this bonus is doubled after Modern Agriculture is researched. +3 [ICON_GOLD] Gold from each type of Crops, Cuisine, Fruit, Vegetable, Brewing, Beverage, Oil, Seasoning or Seafood Resource you controlled. [NEWLINE][NEWLINE]When the city is [ICON_POWER] powered, +50% [ICON_FOOD] Food and [ICON_PRODUCTION] Production and +100% [ICON_TOURISM] Tourism from [ICON_GreatWork_Product] Products in this city."),
    ("LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT",                      "[ICON_GREATMERCHANT] Great Merchant"),
    ("LOC_BUILDING_SHOPPING_MALL_NAME",                           "Department Store"),
    ("LOC_BUILDING_SHOPPING_MALL_DESCRIPTION",                    "+10% accumulation rate for [ICON_GREATMERCHANT] Great Merchant Points, this bonus is doubled after Finance is researched. +3 [ICON_GOLD] Gold from each type of Leather, Cloth, Marine Products, Medicine, Stationery, Art, Decoration, Ornamental or Household Resource you controlled. "),
    ("LOC_BUILDING_SHOPPING_MALL_DESCRIPTION_CORP",               "+10% accumulation rate for [ICON_GREATMERCHANT] Great Merchant Points, this bonus is doubled after Finance is researched. +3 [ICON_GOLD] Gold from each type of Leather, Cloth, Marine Products, Medicine, Stationery, Art, Decoration, Ornamental or Household Resource you controlled. [NEWLINE][NEWLINE]When the city is [ICON_POWER] powered, +50% [ICON_Gold] Gold and [ICON_Faith] Faith and +100% [ICON_TOURISM] Tourism from [ICON_GreatWork_Product] Products in this city."),
    ...
    ("LOC_BUILDING_SANCTUARY_DESCRIPTION",                        "Upon completion, it will cause the population of one randomly Biological Resource in this city to expand nearby. Rainforest, Marsh and Floodplains tiles in this city grant +1 Appeal to adjacent tiles. +1 [ICON_FOOD] Food to all Features and Natural Wonders in this city; extra +2 [ICON_GOLD] Gold if with Charming appeal; extra +4 [ICON_GOLD] Gold if with Breathtaking appeal."),
    ...
    ("LOC_BUILDING_HD_CULTURE_HERITAGE_PRESERVE_DESCRIPTION",     "+1 [ICON_CULTURE] Culture and +3 [ICON_GOLD] Gold to World Wonders, Unique Improvements and City-state Improvements with Charming Appeal in this city, doubled if these tiles have Breathtaking Appeal. +100% Tourism from World Wonders, Unique Improvements and City-state Improvements in this city."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_WALLS_HD_DESCRIPTION",                         "提供环绕市中心和军营的城墙。城墙使市中心和军营能发起 [ICON_RANGED] 远程攻击。必须先击毁城墙方能进攻城市。"),
    ("zh_Hans_CN",  "LOC_BUILDING_CASTLE_HD_DESCRIPTION",                        "提升外部防御力。此城不受“破城槌”特效影响。"),
    ("zh_Hans_CN",  "LOC_BUILDING_STAR_FORT_HD_DESCRIPTION",                     "将外部防御能力提升至最高级。此城不受“破城槌”或“攻城塔”特效影响。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_TSIKHE_DESCRIPTION_XP2",                       "格鲁吉亚特色建筑。[ICON_Production] 生产力花费低于中世纪城墙，并拥有更强的外部防御力。提供+4 [ICON_Faith] 信仰值，进入黄金时代后额外+12 [ICON_Faith] 信仰值。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_TABLES_OF_LAW_NAME",                        "法表"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_TABLES_OF_LAW_DESCRIPTION",                 "[ICON_CAPITAL] 首都每位 [ICON_CITIZEN] 公民+0.3 [ICON_CULTURE] 文化值。市政广场所在城市每位 [ICON_CITIZEN] 公民+0.3 [ICON_PRODUCTION] 生产力。[NEWLINE][NEWLINE]必须建造在 [ICON_CAPITAL] 首都。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_ALCHEMY_ROOM_DESCRIPTION",                  "若本城拥有改良的冶金或医药资源，+3 [ICON_SCIENCE] 科技值和+6 [ICON_FAITH] 信仰值。允许使用 [ICON_FAITH] 信仰值购买开拓者、使徒、上师、审判官，拥有特定信仰还可购买武僧。"),
    -- 军营
    ...
    -- 娱乐区
    ("zh_Hans_CN",  "LOC_BUILDING_ARENA_HD_DESCRIPTION",                         "若你拥有至少3种皮革或珍兽资源，辐射产出+1 [ICON_Culture] 文化值且+1辐射范围。"),
    ("zh_Hans_CN",  "LOC_BUILDING_TLACHTLI_HD_DESCRIPTION",                      "阿兹特克特色建筑。若你拥有至少3种庆典或家居资源，辐射产出+1 [ICON_Culture] 文化值和 [ICON_FAITH] 信仰值且+1辐射范围。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_AQUARIUM_DL_DESCRIPTION",                      "你每拥有一种海鲜或海货资源，+2 [ICON_SCIENCE] 科技值。你每拥有一种海兽资源，+6 [ICON_CULTURE] 文化值。"),
    -- 航空港
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_DESCRIPTION",                      "玩家的{LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT}点数积累速度+10%，解锁“现代农业”科技后翻倍。你每拥有一种庄稼、美食、水果、蔬菜、酿造、饮料、油料、调料或海鲜资源，+3 [ICON_GOLD] 金币。"),
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_DESCRIPTION_CORP",                 "玩家的{LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT}点数积累速度+10%，解锁“现代农业”科技后翻倍。你每拥有一种庄稼、美食、水果、蔬菜、酿造、饮料、油料、调料或海鲜资源，+3 [ICON_GOLD] 金币。[NEWLINE][NEWLINE]若 [ICON_POWER] 供电充足，本城的 [ICON_GreatWork_Product] 产品提供1.5倍的 [ICON_FOOD] 食物和 [ICON_PRODUCTION] 生产力，且 [ICON_TOURISM] 旅游业绩+100%。"),
    ("zh_Hans_CN",  "LOC_BUILDING_FOOD_MARKET_BUFF_OBJECT",                      " [ICON_GREATMERCHANT] 大商人"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_NAME",                           "百货大楼"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_DESCRIPTION",                    "玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%，解锁“金融学”市政后翻倍。你每拥有一种皮革、服装、海货、医药、文具、艺术、饰品、花木或家居资源，+3 [ICON_GOLD] 金币。"),
    ("zh_Hans_CN",  "LOC_BUILDING_SHOPPING_MALL_DESCRIPTION_CORP",               "玩家的 [ICON_GREATMERCHANT] 大商人点数积累速度+10%，解锁“金融学”市政后翻倍。你每拥有一种皮革、服装、海货、医药、文具、艺术、饰品、花木或家居资源，+3 [ICON_GOLD] 金币。[NEWLINE][NEWLINE]若 [ICON_POWER] 供电充足，本城的 [ICON_GreatWork_Product] 产品提供1.5倍的 [ICON_Gold] 金币和 [ICON_Faith] 信仰，且 [ICON_TOURISM] 旅游业绩+100%。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_SANCTUARY_DESCRIPTION",                        "建成后，使本城的随机一种生物类资源在附近种群扩张。本城的雨林、草本沼泽和泛滥单元格为周围单元格+1魅力。本城的地貌和自然奇观+1 [ICON_FOOD] 食物；若位于迷人单元格，则额外+2 [ICON_GOLD] 金币；若位于惊艳单元格，则额外+4 [ICON_GOLD] 金币。"),
    ("zh_Hans_CN",  "LOC_BUILDING_SANCTUARY_TEXT",                               "{1_Name}的种群扩张了"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CULTURE_HERITAGE_PRESERVE_NAME",            "人文遗产保护部"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CULTURE_HERITAGE_PRESERVE_DESCRIPTION",     "本城位于迷人单元格的世界奇观、特色改良和城邦改良+1 [ICON_CULTURE] 文化值、+3 [ICON_GOLD] 金币；若位于惊艳单元格，则收益翻倍。本城的奇观、特色改良和城邦改良提供的 [ICON_TOURISM] 旅游业绩+100%。"),
