...
values
    ...
    ("LOC_BUILDING_HD_CULTURE_HERITAGE_PRESERVE_DESCRIPTION",     "+1 [ICON_CULTURE] Culture and +3 [ICON_GOLD] Gold to World Wonder or Unique Improvement tiles with Charming Appeal in this city, doubled if these tiles have Breathtaking Appeal. +100% Tourism from World Wonders, Unique Improvements and City-state Improvements in this city."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_CULTURE_HERITAGE_PRESERVE_DESCRIPTION",     "本城位于迷人单元格的世界奇观和特色改良设施+1 [ICON_CULTURE] 文化值、+3 [ICON_GOLD] 金币；若位于惊艳单元格，则收益翻倍。本城的奇观、特色改良和城邦改良提供的 [ICON_TOURISM] 旅游业绩+100%。"),
