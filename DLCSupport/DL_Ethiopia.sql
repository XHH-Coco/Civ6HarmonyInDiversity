...
values
	...
	('POLICY_HD_MODERNIZATION_LAW',		'HD_MODERNIZATION_LAW_PRODUCTION_ATTACH_3'),
	('POLICY_HD_MODERNIZATION_LAW',		'HD_MODERNIZATION_LAW_SCIENCE_ATTACH_3'),
	('POLICY_HD_MODERNIZATION_LAW',		'HD_MODERNIZATION_LAW_CULTURE_ATTACH_3');
...
values
  ...
  ('HD_MODERNIZATION_LAW_PRODUCTION_ATTACH_3',            'MODIFIER_PLAYER_DISTRICTS_ATTACH_MODIFIER',                'HD_PLOT_HAS_DISTRICT_DIPLOMATIC_QUARTER_TIER_3_BUILDING_REQUIREMENTS'),
  ('HD_MODERNIZATION_LAW_SCIENCE_ATTACH_3',               'MODIFIER_PLAYER_DISTRICTS_ATTACH_MODIFIER',                'HD_PLOT_HAS_DISTRICT_DIPLOMATIC_QUARTER_TIER_3_BUILDING_REQUIREMENTS'),
  ('HD_MODERNIZATION_LAW_CULTURE_ATTACH_3',               'MODIFIER_PLAYER_DISTRICTS_ATTACH_MODIFIER',                'HD_PLOT_HAS_DISTRICT_DIPLOMATIC_QUARTER_TIER_3_BUILDING_REQUIREMENTS'),
  ...
  ('HD_MODERNIZATION_LAW_PRODUCTION_3',                   'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',          'HD_OBJECT_WITHIN_9_TILES'),
  ('HD_MODERNIZATION_LAW_SCIENCE_3',                      'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',          'HD_OBJECT_WITHIN_9_TILES'),
  ('HD_MODERNIZATION_LAW_CULTURE_3',                      'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',          'HD_OBJECT_WITHIN_9_TILES');
...
values
  ...
  ('HD_MODERNIZATION_LAW_PRODUCTION_ATTACH_3',            'ModifierId',       'HD_MODERNIZATION_LAW_PRODUCTION_3'),
  ('HD_MODERNIZATION_LAW_SCIENCE_ATTACH_3',               'ModifierId',       'HD_MODERNIZATION_LAW_SCIENCE_3'),
  ('HD_MODERNIZATION_LAW_CULTURE_ATTACH_3',               'ModifierId',       'HD_MODERNIZATION_LAW_CULTURE_3'),
	('HD_CONSTITUTIONAL_STUDY_PRODUCTION_DIP_1',			'YieldType',  		'YIELD_PRODUCTION'),
	('HD_CONSTITUTIONAL_STUDY_PRODUCTION_DIP_1',			'Amount',			2),
	('HD_CONSTITUTIONAL_STUDY_PRODUCTION_DIP_2',			'YieldType',  		'YIELD_PRODUCTION'),
	('HD_CONSTITUTIONAL_STUDY_PRODUCTION_DIP_2',			'Amount',			2),
	('HD_CONSTITUTIONAL_STUDY_PRODUCTION_DIP_3',			'YieldType',  		'YIELD_PRODUCTION'),
	('HD_CONSTITUTIONAL_STUDY_PRODUCTION_DIP_3',			'Amount',			2),
	('HD_CONSTITUTIONAL_STUDY_GOLD_DIP_1',					'YieldType',  		'YIELD_GOLD'),
	('HD_CONSTITUTIONAL_STUDY_GOLD_DIP_1',					'Amount',			2),
	('HD_CONSTITUTIONAL_STUDY_GOLD_DIP_2',					'YieldType',  		'YIELD_GOLD'),
	('HD_CONSTITUTIONAL_STUDY_GOLD_DIP_2',					'Amount',			2),
	('HD_CONSTITUTIONAL_STUDY_GOLD_DIP_3',					'YieldType',  		'YIELD_GOLD'),
	('HD_CONSTITUTIONAL_STUDY_GOLD_DIP_3',					'Amount',			2),
	('HD_MODERNIZATION_LAW_PRODUCTION_3',					'YieldType',  		'YIELD_PRODUCTION'),
	('HD_MODERNIZATION_LAW_PRODUCTION_3',					'Amount',			2),
	('HD_MODERNIZATION_LAW_SCIENCE_3',						'YieldType',  		'YIELD_SCIENCE'),
	('HD_MODERNIZATION_LAW_SCIENCE_3',						'Amount',			2),
	('HD_MODERNIZATION_LAW_CULTURE_3',						'YieldType',  		'YIELD_CULTURE'),
	('HD_MODERNIZATION_LAW_CULTURE_3',						'Amount',			2);