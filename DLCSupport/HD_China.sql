...
insert or replace into Modifiers (ModifierId, ModifierType, RunOnce, Permanent) values
	('LISI_FREE_CIVIC',	'MODIFIER_PLAYER_ADJUST_PROPERTY', 1, 1);
...
values
	...
	('LISI_FREE_CIVIC',							'Key',		'HD_FREE_CIVIC'),
  ('LISI_FREE_CIVIC',							'Amount',	1);
...
values
	...
	('LISI_FREE_CIVIC',									'Summary',		'LOC_LISI_TEXT'),
...
values
	...
	('GREAT_PERSON_INDIVIDUAL_LISI',				'LISI_FREE_CIVIC',					'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),
