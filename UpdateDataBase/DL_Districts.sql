...
values
	...
	('DISTRICT_STREET_CARNIVAL',							'HD_BANDEIRANTES_ADD_TIMES'),
	...
	('DISTRICT_WATER_STREET_CARNIVAL',				'HD_BANDEIRANTES_ADD_TIMES'),
...
values
	...
	('HD_BANDEIRANTES_ADD_TIMES',													'MODIFIER_PLAYER_UNITS_ADJUST_PROPERTY',					null,																										null);
...
values
	...
	('HD_BANDEIRANTES_ADD_TIMES', 												'Key',					'HD_BANDEIRANTES_TIMES'),
	('HD_BANDEIRANTES_ADD_TIMES',													'Amount',				1);
...
values
	('COMMERCIAL_HUB_OR_HARBOR_GRANT_TRADING_POST',			'MODIFIER_SINGLE_CITY_GRANT_TRADING_POST', 'HD_CITY_HAS_COMMERCIAL_HUB_OR_HARBOR_REQUIREMENTS'),
	...
	('HANSA_ADD_ADJACENT_RESOURCE_PRODUCTION',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',			'HD_ADJACENT_RESOURCE_REQUIREMENTS'),
