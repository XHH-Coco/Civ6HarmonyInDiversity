...
values
  ...
  ('PLOT_IS_HILLS',                                               'REQUIREMENTSET_TEST_ALL'),
	...
	('PLOT_HAS_RESOURCE_REQUIREMENTS_AND_ON_TUNDRA_OR_SNOW',				'REQUIREMENTSET_TEST_ALL'),
	('PLOT_IS_TUNDRA_OR_SNOW_AND_IS_SPECIALTY_DISTRICT_REQUIREMENTS',		'REQUIREMENTSET_TEST_ALL');
...
values
  ...
  ('ENCAMPMENT_ON_OR_ADJACENT_TO_DESERT',                         'REQUIRES_DISTRICT_IS_DISTRICT_ENCAMPMENT'),
	...
	('PLOT_HAS_RESOURCE_REQUIREMENTS_AND_ON_TUNDRA_OR_SNOW',			'REQUIRES_PLOT_IS_TUNDRA_OR_SNOW'),
	('PLOT_HAS_RESOURCE_REQUIREMENTS_AND_ON_TUNDRA_OR_SNOW',			'PLOT_HAS_RESOURCE_REQUIREMENTS'),
	('PLOT_IS_TUNDRA_OR_SNOW_AND_IS_SPECIALTY_DISTRICT_REQUIREMENTS',	'HD_REQUIRES_DISTRICT_IS_SPECIALTY_DISTRICT'),
	('PLOT_IS_TUNDRA_OR_SNOW_AND_IS_SPECIALTY_DISTRICT_REQUIREMENTS',	'REQUIRES_PLOT_IS_TUNDRA_OR_SNOW');
