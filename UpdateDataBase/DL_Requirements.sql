...
values
	...
	('REQUIRES_HD_PATHFINDER_FAITH_MAJOR_CIV',				'REQUIREMENT_PLOT_PROPERTY_MATCHES'),
	('REQUIRES_HD_PATHFINDER_FAITH_CITYSTATE',				'REQUIREMENT_PLOT_PROPERTY_MATCHES'),
	('REQUIRES_HD_PATHFINDER_FAITH_NEW_CONTINENT',				'REQUIREMENT_PLOT_PROPERTY_MATCHES'),
	('REQUIRES_HD_PATHFINDER_FAITH_NATURAL_WONDER',				'REQUIREMENT_PLOT_PROPERTY_MATCHES'),
...
values
	...
	('REQUIRES_HD_PATHFINDER_FAITH_MAJOR_CIV',					'PropertyName',			'HD_PATHFINDER_FAITH_MAJOR_CIV'),
	('REQUIRES_HD_PATHFINDER_FAITH_MAJOR_CIV',					'PropertyMinimum',	1),
	('REQUIRES_HD_PATHFINDER_FAITH_CITYSTATE',					'PropertyName',			'HD_PATHFINDER_FAITH_CITYSTATE'),
	('REQUIRES_HD_PATHFINDER_FAITH_CITYSTATE',					'PropertyMinimum',	1),
	('REQUIRES_HD_PATHFINDER_FAITH_NEW_CONTINENT',			'PropertyName',			'HD_PATHFINDER_FAITH_NEW_CONTINENT'),
	('REQUIRES_HD_PATHFINDER_FAITH_NEW_CONTINENT',			'PropertyMinimum',	1),
	('REQUIRES_HD_PATHFINDER_FAITH_NATURAL_WONDER',			'PropertyName',			'HD_PATHFINDER_FAITH_NATURAL_WONDER'),
	('REQUIRES_HD_PATHFINDER_FAITH_NATURAL_WONDER',			'PropertyMinimum',	1),
...
values
	...
	('PLOT_HAS_PASTURE_WITH_6_TILES_REQUIRMENTS',								'REQUIREMENTSET_TEST_ALL'),
	('PLOT_HAS_IMPROVEMENT_CLASSIFICATION_COMMERCIAL_FACILITIES_WITH_6_TILES_REQUIRMENTS',								'REQUIREMENTSET_TEST_ALL'),
  ...
  ('PLOT_IS_HILLS',                                               'REQUIREMENTSET_TEST_ALL'),
	...
	('HD_PATHFINDER_FAITH_MAJOR_CIV_REQUIREMENTS',	'REQUIREMENTSET_TEST_ALL'),
	('HD_PATHFINDER_FAITH_CITYSTATE_REQUIREMENTS',	'REQUIREMENTSET_TEST_ALL'),
	('HD_PATHFINDER_FAITH_NEW_CONTINENT_REQUIREMENTS',	'REQUIREMENTSET_TEST_ALL'),
	('HD_PATHFINDER_FAITH_NATURAL_WONDER_REQUIREMENTS',	'REQUIREMENTSET_TEST_ALL'),
...
values
	...
	('PLOT_HAS_PASTURE_WITH_6_TILES_REQUIRMENTS',								'REQUIRES_OBJECT_WITHIN_6_TILES'),
	('PLOT_HAS_PASTURE_WITH_6_TILES_REQUIRMENTS',								'REQUIRES_PLOT_HAS_IMPROVEMENT_PASTURE'),
	('PLOT_HAS_IMPROVEMENT_CLASSIFICATION_COMMERCIAL_FACILITIES_WITH_6_TILES_REQUIRMENTS',								'REQUIRES_OBJECT_WITHIN_6_TILES'),
	('PLOT_HAS_IMPROVEMENT_CLASSIFICATION_COMMERCIAL_FACILITIES_WITH_6_TILES_REQUIRMENTS',								'REQUIRES_PLOT_HAS_IMPROVEMENT_CLASSIFICATION_COMMERCIAL_FACILITIES'),
  ...
  ('ENCAMPMENT_ON_OR_ADJACENT_TO_DESERT',                         'REQUIRES_DISTRICT_IS_DISTRICT_ENCAMPMENT'),
	...
	('HD_PATHFINDER_FAITH_MAJOR_CIV_REQUIREMENTS',	'REQUIRES_HD_PATHFINDER_FAITH_MAJOR_CIV'),
	('HD_PATHFINDER_FAITH_CITYSTATE_REQUIREMENTS',	'REQUIRES_HD_PATHFINDER_FAITH_CITYSTATE'),
	('HD_PATHFINDER_FAITH_NEW_CONTINENT_REQUIREMENTS',	'REQUIRES_HD_PATHFINDER_FAITH_NEW_CONTINENT'),
	('HD_PATHFINDER_FAITH_NATURAL_WONDER_REQUIREMENTS',	'REQUIRES_HD_PATHFINDER_FAITH_NATURAL_WONDER'),
