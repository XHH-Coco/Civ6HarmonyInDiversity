...
values
  ...
  ('PLOT_IS_HILLS',                                               'REQUIREMENTSET_TEST_ALL'),
	...
	('HD_PLOT_HAS_CITY_OR_WATER_PARK_IMPROVEMENT_WITHIN_5_TILES_REQUIREMENTS',  'REQUIREMENTSET_TEST_ALL'),
...
values
  ...
  ('ENCAMPMENT_ON_OR_ADJACENT_TO_DESERT',                         'REQUIRES_DISTRICT_IS_DISTRICT_ENCAMPMENT'),
	...
	('HD_PLOT_HAS_CITY_OR_WATER_PARK_IMPROVEMENT_WITHIN_5_TILES_REQUIREMENTS',  'REQUIRES_PLOT_HAS_IMPROVEMENT_CITY_PARK'),
	('HD_PLOT_HAS_CITY_OR_WATER_PARK_IMPROVEMENT_WITHIN_5_TILES_REQUIREMENTS',  'REQUIRES_OBJECT_WITHIN_5_TILES'),
