...
values
	...
	('REQUIRES_HD_AGRICULTURAL_MECHANIZATION',				'REQUIREMENT_REQUIREMENTSET_IS_MET'),
	('REQUIRES_PLOT_HAS_CIV_OR_CITYSTATE_UNIQUE',				'REQUIREMENT_REQUIREMENTSET_IS_MET'),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_3_ADJACENCY',				'REQUIREMENT_CITY_HAS_HIGH_ADJACENCY_DISTRICT'),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_9_ADJACENCY',				'REQUIREMENT_CITY_HAS_HIGH_ADJACENCY_DISTRICT'),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_12_ADJACENCY',			'REQUIREMENT_CITY_HAS_HIGH_ADJACENCY_DISTRICT'),
...
values
	...
	('REQUIRES_HD_AGRICULTURAL_MECHANIZATION',			'RequirementSetId',	'HD_AGRICULTURAL_MECHANIZATION_REQUIREMENTS'),
	('REQUIRES_PLOT_HAS_CIV_OR_CITYSTATE_UNIQUE',			'RequirementSetId',	'PLOT_HAS_CIV_OR_CITYSTATE_UNIQUE_REQUIREMENTS'),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_3_ADJACENCY',			'DistrictType',	'DISTRICT_INDUSTRIAL_ZONE'),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_3_ADJACENCY',			'Amount',				3),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_3_ADJACENCY',			'YieldType',		'YIELD_PRODUCTION'),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_9_ADJACENCY',			'DistrictType',	'DISTRICT_INDUSTRIAL_ZONE'),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_9_ADJACENCY',			'Amount',				9),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_9_ADJACENCY',			'YieldType',		'YIELD_PRODUCTION'),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_12_ADJACENCY',		'DistrictType',	'DISTRICT_INDUSTRIAL_ZONE'),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_12_ADJACENCY',		'Amount',				12),
	('REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_12_ADJACENCY',		'YieldType',		'YIELD_PRODUCTION'),
...
values
  ...
  ('PLOT_IS_HILLS',                                               'REQUIREMENTSET_TEST_ALL'),
	...
	('HD_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',	'REQUIREMENTSET_TEST_ANY'),
	('HD_ADJACENT_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',	'REQUIREMENTSET_TEST_ALL'),
	('HD_UNMANNED_FACTORY_REQUIREMENTS',	'REQUIREMENTSET_TEST_ANY'),
	...
	('HD_CITY_DISTRICT_INDUSTRIAL_ZONE_HAS_3_ADJACENCY_REQUIREMENTS',				'REQUIREMENTSET_TEST_ALL'),
	('HD_CITY_DISTRICT_INDUSTRIAL_ZONE_HAS_9_ADJACENCY_REQUIREMENTS',				'REQUIREMENTSET_TEST_ALL'),
	('HD_CITY_DISTRICT_INDUSTRIAL_ZONE_HAS_12_ADJACENCY_REQUIREMENTS',				'REQUIREMENTSET_TEST_ALL'),
...
values
  ...
  ('ENCAMPMENT_ON_OR_ADJACENT_TO_DESERT',                         'REQUIRES_DISTRICT_IS_DISTRICT_ENCAMPMENT'),
	...
	('HD_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',			'REQUIRES_PLOT_HAS_IMPROVEMENT_CAMP'),
	('HD_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',			'REQUIRES_PLOT_HAS_IMPROVEMENT_FARM'),
	('HD_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',			'REQUIRES_PLOT_HAS_IMPROVEMENT_FISHERY'),
	('HD_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',			'REQUIRES_PLOT_HAS_IMPROVEMENT_FISHING_BOATS'),
	('HD_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',			'REQUIRES_PLOT_HAS_IMPROVEMENT_LUMBER_MILL'),
	('HD_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',			'REQUIRES_PLOT_HAS_IMPROVEMENT_PASTURE'),
	('HD_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',			'REQUIRES_PLOT_HAS_IMPROVEMENT_PLANTATION'),
	('HD_ADJACENT_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',			'ADJACENT_TO_OWNER'),
	('HD_ADJACENT_AGRICULTURAL_MECHANIZATION_REQUIREMENTS',			'REQUIRES_HD_AGRICULTURAL_MECHANIZATION'),
	('HD_UNMANNED_FACTORY_REQUIREMENTS',								'REQUIRES_PLOT_HAS_IMPROVEMENT_MINE'),
	('HD_UNMANNED_FACTORY_REQUIREMENTS',								'REQUIRES_PLOT_HAS_IMPROVEMENT_OFFSHORE_OIL_RIG'),
	('HD_UNMANNED_FACTORY_REQUIREMENTS',								'REQUIRES_PLOT_HAS_IMPROVEMENT_OIL_WELL'),
	('HD_UNMANNED_FACTORY_REQUIREMENTS',								'REQUIRES_PLOT_HAS_IMPROVEMENT_QUARRY'),
	...
	('HD_CITY_DISTRICT_INDUSTRIAL_ZONE_HAS_3_ADJACENCY_REQUIREMENTS',								'REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_3_ADJACENCY'),
	('HD_CITY_DISTRICT_INDUSTRIAL_ZONE_HAS_9_ADJACENCY_REQUIREMENTS',								'REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_9_ADJACENCY'),
	('HD_CITY_DISTRICT_INDUSTRIAL_ZONE_HAS_12_ADJACENCY_REQUIREMENTS',							'REQUIRES_DISTRICT_INDUSTRIAL_ZONE_HAS_12_ADJACENCY'),
