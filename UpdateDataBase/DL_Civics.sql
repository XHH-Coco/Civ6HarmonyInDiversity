...
----------------------
-- 删除初始默认选中市政
delete from StartingCivics where Civic = 'CIVIC_CODE_OF_LAWS' and Era = 'ERA_ANCIENT';
...
values
	...
	-- 原始军事
	('CIVIC_EARLY_WARFARE_HD',								'KIND_CIVIC'),
	-- 丧仪
	('CIVIC_FUNERAL_HD',											'KIND_CIVIC'),
	-- 户籍管理
	('CIVIC_HOUSEHOLD_REGISTRATION_HD',				'KIND_CIVIC'),
	-- 纹章学
	('CIVIC_HERALDRY_HD',											'KIND_CIVIC'),
	-- 商业资本主义
	('CIVIC_COMMERCIAL_CAPITALISM_HD',				'KIND_CIVIC'),
	-- 法学
	('CIVIC_LAW_HD',													'KIND_CIVIC'),
	-- 新闻学
	('CIVIC_JOURNALISM_STUDIES_HD',						'KIND_CIVIC'),
	-- 人权
	('CIVIC_HUMAN_RIGHTS_HD',									'KIND_CIVIC'),
	-- 警察制度
	('CIVIC_POLICE_SYSTEM_HD',								'KIND_CIVIC'),
	-- 博物馆学
	('CIVIC_MUSEOLOGY_HD',										'KIND_CIVIC'),
	-- 社会保障制度
	('CIVIC_SOCIAL_SECURITY_SYSTEM_HD',				'KIND_CIVIC'),
	-- 古生物学
	('CIVIC_PALEOBIOLOGY_HD',									'KIND_CIVIC'),
	-- 人类学
	('CIVIC_ANTHROPOLOGY_HD',									'KIND_CIVIC'),
	-- 城市设计
	('CIVIC_URBAN_DESIGN_HD',									'KIND_CIVIC'),
	-- 国际联盟
	('CIVIC_LEAGUE_OF_NATIONS_HD',						'KIND_CIVIC'),
	-- 金融学
	('CIVIC_FINANCE_HD',											'KIND_CIVIC'),
	-- 高等教育
	('CIVIC_HIGHER_EDUCATION_HD',							'KIND_CIVIC'),
	-- 新殖民主义
	('CIVIC_NEOCOLONIALISM_HD',								'KIND_CIVIC'),
	-- 现代主义思潮
	('CIVIC_MODERNISM_HD',										'KIND_CIVIC'),
	-- 国际主义
	('CIVIC_INTERNATIONALISM_HD',							'KIND_CIVIC');
...
values
	...
	('CIVIC_HISTORICAL_PHILOSOPHY_HD',				'LOC_CIVIC_HISTORICAL_PHILOSOPHY_HD_NAME',					'LOC_CIVIC_HISTORICAL_PHILOSOPHY_HD_DESCRIPTION',					1050,	'ERA_RENAISSANCE',	0,					'ADVISOR_CULTURE'),
	...
	-- 纹章学
	('CIVIC_HERALDRY_HD',											'LOC_CIVIC_HERALDRY_HD_NAME',												'LOC_CIVIC_HERALDRY_HD_DESCRIPTION',											450,	'ERA_MEDIEVAL',			-2,					'ADVISOR_CONQUEST'),
	-- 商业资本主义
	('CIVIC_COMMERCIAL_CAPITALISM_HD',				'LOC_CIVIC_COMMERCIAL_CAPITALISM_HD_NAME',					NULL,																											900,	'ERA_RENAISSANCE',	-1,					'ADVISOR_GENERIC'),
	-- 法学
	('CIVIC_LAW_HD',													'LOC_CIVIC_LAW_HD_NAME',														NULL,																											1450,	'ERA_INDUSTRIAL',		1,					'ADVISOR_GENERIC'),
	-- 新闻学
	('CIVIC_JOURNALISM_STUDIES_HD',						'LOC_CIVIC_JOURNALISM_STUDIES_HD_NAME',							NULL,																											1700,	'ERA_INDUSTRIAL',		2,					'ADVISOR_CULTURE'),
	-- 人权
	('CIVIC_HUMAN_RIGHTS_HD',									'LOC_CIVIC_HUMAN_RIGHTS_HD_NAME',										NULL,																											1700,	'ERA_INDUSTRIAL',		0,					'ADVISOR_GENERIC'),
	-- 警察制度
	('CIVIC_POLICE_SYSTEM_HD',								'LOC_CIVIC_POLICE_SYSTEM_HD_NAME',									NULL,																											1700,	'ERA_INDUSTRIAL',		1,					'ADVISOR_GENERIC'),
	-- 博物馆学
	('CIVIC_MUSEOLOGY_HD',										'LOC_CIVIC_MUSEOLOGY_HD_NAME',											NULL,																											2100,	'ERA_MODERN',				-3,					'ADVISOR_CULTURE'),
	-- 社会保障制度
	('CIVIC_SOCIAL_SECURITY_SYSTEM_HD',				'LOC_CIVIC_SOCIAL_SECURITY_SYSTEM_HD_NAME',					NULL,																											2100,	'ERA_MODERN',				0,					'ADVISOR_GENERIC'),
	-- 古生物学
	('CIVIC_PALEOBIOLOGY_HD',									'LOC_CIVIC_PALEOBIOLOGY_HD_NAME',										'LOC_CIVIC_PALEOBIOLOGY_HD_DESCRIPTION',									2250,	'ERA_MODERN',				-3,					'ADVISOR_CULTURE'),
	-- 人类学
	('CIVIC_ANTHROPOLOGY_HD',									'LOC_CIVIC_ANTHROPOLOGY_HD_NAME',										NULL,																											2250,	'ERA_MODERN',				-2,					'ADVISOR_CULTURE'),
	-- 城市设计
	('CIVIC_URBAN_DESIGN_HD',									'LOC_CIVIC_URBAN_DESIGN_HD_NAME',										NULL,																											2250,	'ERA_MODERN',				0,					'ADVISOR_GENERIC'),
	-- 国际联盟
	('CIVIC_LEAGUE_OF_NATIONS_HD',						'LOC_CIVIC_LEAGUE_OF_NATIONS_HD_NAME',							NULL,																											2250,	'ERA_MODERN',				2,					'ADVISOR_GENERIC'),
	-- 金融学
	('CIVIC_FINANCE_HD',											'LOC_CIVIC_FINANCE_HD_NAME',												'LOC_CIVIC_FINANCE_HD_DESCRIPTION',												2400,	'ERA_MODERN',				-2,					'ADVISOR_GENERIC'),
	-- 高等教育
	('CIVIC_HIGHER_EDUCATION_HD',							'LOC_CIVIC_HIGHER_EDUCATION_HD_NAME',								NULL,																											2400,	'ERA_MODERN',				2,					'ADVISOR_TECHNOLOGY'),
	-- 新殖民主义
	('CIVIC_NEOCOLONIALISM_HD',								'LOC_CIVIC_NEOCOLONIALISM_HD_NAME',									'LOC_CIVIC_NEOCOLONIALISM_HD_DESCRIPTION',								3000,	'ERA_ATOMIC',				0,					'ADVISOR_GENERIC'),
	-- 现代主义思潮
	('CIVIC_MODERNISM_HD',										'LOC_CIVIC_MODERNISM_HD_NAME',											NULL,																											3500,	'ERA_ATOMIC',				-2,					'ADVISOR_CULTURE'),
	-- 国际主义
	('CIVIC_INTERNATIONALISM_HD',							'LOC_CIVIC_INTERNATIONALISM_HD_NAME',								NULL,																											3500,	'ERA_ATOMIC',				2,					'ADVISOR_GENERIC');
...
delete from CivicQuotes where CivicType = 'CIVIC_SCORCHED_EARTH';
delete from CivicQuotes where CivicType = 'CIVIC_CAPITALISM';
...
values
	...
	('CIVIC_EARLY_WARFARE_HD',    						'LOC_CIVIC_EARLY_WARFARE_HD_QUOTE_1',     					'PLAY_CIVIC_EARLY_WARFARE_HD_QUOTE_1'),
	('CIVIC_EARLY_WARFARE_HD',    						'LOC_CIVIC_EARLY_WARFARE_HD_QUOTE_2',     					'PLAY_CIVIC_EARLY_WARFARE_HD_QUOTE_2'),
	('CIVIC_FUNERAL_HD',    									'LOC_CIVIC_FUNERAL_HD_QUOTE_1',     								'PLAY_CIVIC_FUNERAL_HD_QUOTE_1'),
	('CIVIC_FUNERAL_HD',    									'LOC_CIVIC_FUNERAL_HD_QUOTE_2',     								'PLAY_CIVIC_FUNERAL_HD_QUOTE_2'),
	('CIVIC_HOUSEHOLD_REGISTRATION_HD',    		'LOC_CIVIC_HOUSEHOLD_REGISTRATION_HD_QUOTE_1',     	'PLAY_CIVIC_HOUSEHOLD_REGISTRATION_HD_QUOTE_1'),
	('CIVIC_HOUSEHOLD_REGISTRATION_HD',    		'LOC_CIVIC_HOUSEHOLD_REGISTRATION_HD_QUOTE_2',     	'PLAY_CIVIC_HOUSEHOLD_REGISTRATION_HD_QUOTE_2'),
	('CIVIC_HERALDRY_HD',    									'LOC_CIVIC_HERALDRY_HD_QUOTE_1',     								'PLAY_CIVIC_HERALDRY_HD_QUOTE_1'),
	('CIVIC_HERALDRY_HD',    									'LOC_CIVIC_HERALDRY_HD_QUOTE_2',     								'PLAY_CIVIC_HERALDRY_HD_QUOTE_2'),
	('CIVIC_COMMERCIAL_CAPITALISM_HD',    		'LOC_CIVIC_COMMERCIAL_CAPITALISM_HD_QUOTE_1',     	'PLAY_CIVIC_COMMERCIAL_CAPITALISM_HD_QUOTE_1'),
	('CIVIC_COMMERCIAL_CAPITALISM_HD',    		'LOC_CIVIC_COMMERCIAL_CAPITALISM_HD_QUOTE_2',     	'PLAY_CIVIC_COMMERCIAL_CAPITALISM_HD_QUOTE_2'),
	('CIVIC_LAW_HD',    											'LOC_CIVIC_LAW_HD_QUOTE_1',     										'PLAY_CIVIC_LAW_HD_QUOTE_1'),
	('CIVIC_LAW_HD',    											'LOC_CIVIC_LAW_HD_QUOTE_2',     										'PLAY_CIVIC_LAW_HD_QUOTE_2'),
	('CIVIC_JOURNALISM_STUDIES_HD',    				'LOC_CIVIC_JOURNALISM_STUDIES_HD_QUOTE_1',     			'PLAY_CIVIC_JOURNALISM_STUDIES_HD_QUOTE_1'),
	('CIVIC_JOURNALISM_STUDIES_HD',    				'LOC_CIVIC_JOURNALISM_STUDIES_HD_QUOTE_2',     			'PLAY_CIVIC_JOURNALISM_STUDIES_HD_QUOTE_2'),
	('CIVIC_HUMAN_RIGHTS_HD',    							'LOC_CIVIC_HUMAN_RIGHTS_HD_QUOTE_1',     						'PLAY_CIVIC_HUMAN_RIGHTS_HD_QUOTE_1'),
	('CIVIC_HUMAN_RIGHTS_HD',    							'LOC_CIVIC_HUMAN_RIGHTS_HD_QUOTE_2',     						'PLAY_CIVIC_HUMAN_RIGHTS_HD_QUOTE_2'),
	('CIVIC_POLICE_SYSTEM_HD',    						'LOC_CIVIC_POLICE_SYSTEM_HD_QUOTE_1',     					'PLAY_CIVIC_POLICE_SYSTEM_HD_QUOTE_1'),
	('CIVIC_POLICE_SYSTEM_HD',    						'LOC_CIVIC_POLICE_SYSTEM_HD_QUOTE_2',     					'PLAY_CIVIC_POLICE_SYSTEM_HD_QUOTE_2'),
	('CIVIC_MUSEOLOGY_HD',    								'LOC_CIVIC_MUSEOLOGY_HD_QUOTE_1',     							'Play_HERMITAGE_QUOTE'),
	('CIVIC_MUSEOLOGY_HD',    								'LOC_CIVIC_MUSEOLOGY_HD_QUOTE_2',     							'PLAY_CIVIC_MUSEOLOGY_HD_QUOTE_2'),
	('CIVIC_SOCIAL_SECURITY_SYSTEM_HD',    		'LOC_CIVIC_SOCIAL_SECURITY_SYSTEM_HD_QUOTE_1',     	'PLAY_CIVIC_SOCIAL_SECURITY_SYSTEM_HD_QUOTE_1'),
	('CIVIC_SOCIAL_SECURITY_SYSTEM_HD',    		'LOC_CIVIC_SOCIAL_SECURITY_SYSTEM_HD_QUOTE_2',     	'PLAY_CIVIC_SOCIAL_SECURITY_SYSTEM_HD_QUOTE_2'),
	('CIVIC_PALEOBIOLOGY_HD',    							'LOC_CIVIC_PALEOBIOLOGY_HD_QUOTE_1',     						'PLAY_CIVIC_PALEOBIOLOGY_HD_QUOTE_1'),
	('CIVIC_PALEOBIOLOGY_HD',    							'LOC_CIVIC_PALEOBIOLOGY_HD_QUOTE_2',     						'PLAY_CIVIC_PALEOBIOLOGY_HD_QUOTE_2'),
	('CIVIC_ANTHROPOLOGY_HD',    							'LOC_CIVIC_ANTHROPOLOGY_HD_QUOTE_1',     						'PLAY_CIVIC_ANTHROPOLOGY_HD_QUOTE_1'),
	('CIVIC_ANTHROPOLOGY_HD',    							'LOC_CIVIC_ANTHROPOLOGY_HD_QUOTE_2',     						'PLAY_CIVIC_ANTHROPOLOGY_HD_QUOTE_2'),
	('CIVIC_URBAN_DESIGN_HD',    							'LOC_CIVIC_URBAN_DESIGN_HD_QUOTE_1',     						'PLAY_CIVIC_URBAN_DESIGN_HD_QUOTE_1'),
	('CIVIC_URBAN_DESIGN_HD',    							'LOC_CIVIC_URBAN_DESIGN_HD_QUOTE_2',     						'PLAY_CIVIC_URBAN_DESIGN_HD_QUOTE_2'),
	('CIVIC_LEAGUE_OF_NATIONS_HD',    				'LOC_CIVIC_LEAGUE_OF_NATIONS_HD_QUOTE_1',     			'PLAY_CIVIC_LEAGUE_OF_NATIONS_HD_QUOTE_1'),
	('CIVIC_LEAGUE_OF_NATIONS_HD',    				'LOC_CIVIC_LEAGUE_OF_NATIONS_HD_QUOTE_2',     			'PLAY_CIVIC_LEAGUE_OF_NATIONS_HD_QUOTE_2'),
	('CIVIC_FINANCE_HD',    									'LOC_CIVIC_FINANCE_HD_QUOTE_1',     								'PLAY_CIVIC_FINANCE_HD_QUOTE_1'),
	('CIVIC_FINANCE_HD',    									'LOC_CIVIC_FINANCE_HD_QUOTE_2',     								'PLAY_CIVIC_FINANCE_HD_QUOTE_2'),
	('CIVIC_HIGHER_EDUCATION_HD',    					'LOC_CIVIC_HIGHER_EDUCATION_HD_QUOTE_1',     				'PLAY_CIVIC_HIGHER_EDUCATION_HD_QUOTE_1'),
	('CIVIC_HIGHER_EDUCATION_HD',    					'LOC_CIVIC_HIGHER_EDUCATION_HD_QUOTE_2',     				'PLAY_CIVIC_HIGHER_EDUCATION_HD_QUOTE_2'),
	('CIVIC_NEOCOLONIALISM_HD',    						'LOC_CIVIC_NEOCOLONIALISM_HD_QUOTE_1',     					'PLAY_CIVIC_NEOCOLONIALISM_HD_QUOTE_1'),
	('CIVIC_NEOCOLONIALISM_HD',    						'LOC_CIVIC_NEOCOLONIALISM_HD_QUOTE_2',     					'PLAY_CIVIC_NEOCOLONIALISM_HD_QUOTE_2'),
	('CIVIC_MODERNISM_HD',    								'LOC_CIVIC_MODERNISM_HD_QUOTE_1',     							'PLAY_CIVIC_MODERNISM_HD_QUOTE_1'),
	('CIVIC_MODERNISM_HD',    								'LOC_CIVIC_MODERNISM_HD_QUOTE_2',     							'PLAY_CIVIC_MODERNISM_HD_QUOTE_2'),
	('CIVIC_INTERNATIONALISM_HD',    					'LOC_CIVIC_INTERNATIONALISM_HD_QUOTE_1',     				'PLAY_CIVIC_INTERNATIONALISM_HD_QUOTE_1'),
	('CIVIC_INTERNATIONALISM_HD',    					'LOC_CIVIC_INTERNATIONALISM_HD_QUOTE_2',     				'PLAY_CIVIC_INTERNATIONALISM_HD_QUOTE_2'),
	('CIVIC_SCORCHED_EARTH',    							'LOC_CIVIC_MODERN_MATIONAL_DEFENSE_HD_QUOTE_1',     'PLAY_CIVIC_MODERN_MATIONAL_DEFENSE_HD_QUOTE_1'),
	('CIVIC_SCORCHED_EARTH',    							'LOC_CIVIC_MODERN_MATIONAL_DEFENSE_HD_QUOTE_2',     'PLAY_CIVIC_MODERN_MATIONAL_DEFENSE_HD_QUOTE_2'),
	('CIVIC_CAPITALISM',   			 							'LOC_CIVIC_MACRO_ECONOMICS_HD_QUOTE_1',     				'PLAY_CIVIC_MACRO_ECONOMICS_HD_QUOTE_1'),
...
values
	...
	('CIVIC_NEOCOLONIALISM_HD',							'CIVIC_GRANT_PLAYER_GOVERNOR_POINTS'),
	-- 被动效果
...
values
	-- 远古 --
	('CIVIC_MILITARY_TRADITION',							'CIVIC_EARLY_WARFARE_HD'),
	('CIVIC_MYSTICISM',												'CIVIC_FUNERAL_HD'),
	('CIVIC_STATE_WORKFORCE',									'CIVIC_CODE_OF_LAWS'),
	('CIVIC_STATE_WORKFORCE',									'CIVIC_FUNERAL_HD'),
	('CIVIC_STATE_WORKFORCE',									'CIVIC_CRAFTSMANSHIP'),
	('CIVIC_EARLY_EMPIRE',										'CIVIC_CODE_OF_LAWS'),
	('CIVIC_EARLY_EMPIRE',										'CIVIC_EARLY_WARFARE_HD'),
	...
	('CIVIC_HOUSEHOLD_REGISTRATION_HD',				'CIVIC_POLITICAL_PHILOSOPHY'),
	-- 中世纪 --
	('CIVIC_NAVAL_TRADITION',									'CIVIC_MILITARY_TRADITION'),
	('CIVIC_MEDIEVAL_FAIRES',									'CIVIC_HOUSEHOLD_REGISTRATION_HD'),
	('CIVIC_IMPERIAL_EXAMINATION_SYSTEM_HD',	'CIVIC_HOUSEHOLD_REGISTRATION_HD'),
	('CIVIC_FEUDALISM',												'CIVIC_HOUSEHOLD_REGISTRATION_HD'),
	...
	('CIVIC_GUILDS',													'CIVIC_HERALDRY_HD'),
	...
	('CIVIC_HERALDRY_HD',											'CIVIC_DEFENSIVE_TACTICS'),
	('CIVIC_HERALDRY_HD',											'CIVIC_MILITARY_TRAINING'),
	-- 文艺复兴 --
	...
	('CIVIC_LAW_HD',													'CIVIC_THE_ENLIGHTENMENT'),
	('CIVIC_LAW_HD',													'CIVIC_ETHICS_HD'),
	('CIVIC_JOURNALISM_STUDIES_HD',						'CIVIC_NATIONALISM'),
	('CIVIC_HUMAN_RIGHTS_HD',									'CIVIC_LAW_HD'),
	('CIVIC_HUMAN_RIGHTS_HD',									'CIVIC_SOCIAL_SCIENCE_HD'),
	('CIVIC_POLICE_SYSTEM_HD',								'CIVIC_LAW_HD'),
	('CIVIC_POLICE_SYSTEM_HD',								'CIVIC_NATIONALISM'),
	-- 现代 --
	('CIVIC_CONSERVATION',										'CIVIC_PALEOBIOLOGY_HD'),
	('CIVIC_CONSERVATION',										'CIVIC_ANTHROPOLOGY_HD'),
	('CIVIC_MASS_MEDIA',											'CIVIC_URBANIZATION'),
	('CIVIC_MASS_MEDIA',											'CIVIC_NATURAL_HISTORY'),
	('CIVIC_MOBILIZATION',										'CIVIC_POLICE_SYSTEM_HD'),
	('CIVIC_MOBILIZATION',										'CIVIC_JOURNALISM_STUDIES_HD'),
	('CIVIC_MOBILIZATION',										'CIVIC_SCORCHED_EARTH'),
	('CIVIC_CAPITALISM',											'CIVIC_MASS_MEDIA'),
	('CIVIC_CAPITALISM',											'CIVIC_SOCIAL_SECURITY_SYSTEM_HD'),
	('CIVIC_IDEOLOGY',												'CIVIC_SOCIAL_SECURITY_SYSTEM_HD'),
	('CIVIC_IDEOLOGY',												'CIVIC_MOBILIZATION'),
	('CIVIC_SUFFRAGE',												'CIVIC_IDEOLOGY'),
	('CIVIC_SUFFRAGE',												'CIVIC_CAPITALISM'),
	('CIVIC_SUFFRAGE',												'CIVIC_URBAN_DESIGN_HD'),
	('CIVIC_TOTALITARIANISM',									'CIVIC_IDEOLOGY'),
	('CIVIC_TOTALITARIANISM',									'CIVIC_CAPITALISM'),
	('CIVIC_TOTALITARIANISM',									'CIVIC_URBAN_DESIGN_HD'),
	('CIVIC_CLASS_STRUGGLE',									'CIVIC_IDEOLOGY'),
	('CIVIC_CLASS_STRUGGLE',									'CIVIC_CAPITALISM'),
	('CIVIC_CLASS_STRUGGLE',									'CIVIC_URBAN_DESIGN_HD'),
	('CIVIC_NUCLEAR_PROGRAM',									'CIVIC_LEAGUE_OF_NATIONS_HD'),
	('CIVIC_MUSEOLOGY_HD',										'CIVIC_NATURAL_HISTORY'),
	('CIVIC_SOCIAL_SECURITY_SYSTEM_HD',				'CIVIC_URBANIZATION'),
	('CIVIC_SOCIAL_SECURITY_SYSTEM_HD',				'CIVIC_HUMAN_RIGHTS_HD'),
	('CIVIC_SOCIAL_SECURITY_SYSTEM_HD',				'CIVIC_POLICE_SYSTEM_HD'),
	('CIVIC_PALEOBIOLOGY_HD',									'CIVIC_MUSEOLOGY_HD'),
	('CIVIC_ANTHROPOLOGY_HD',									'CIVIC_MUSEOLOGY_HD'),
	('CIVIC_LEAGUE_OF_NATIONS_HD',						'CIVIC_MOBILIZATION'),
	('CIVIC_FINANCE_HD',											'CIVIC_CAPITALISM'),
	('CIVIC_HIGHER_EDUCATION_HD',							'CIVIC_IDEOLOGY'),
	('CIVIC_HIGHER_EDUCATION_HD',							'CIVIC_LEAGUE_OF_NATIONS_HD'),
	('CIVIC_URBAN_DESIGN_HD',									'CIVIC_SOCIAL_SECURITY_SYSTEM_HD'),
	-- 原子能 --
	('CIVIC_CULTURAL_HERITAGE',								'CIVIC_FINANCE_HD'),
	('CIVIC_CULTURAL_HERITAGE',								'CIVIC_CONSERVATION'),
	('CIVIC_COLD_WAR',												'CIVIC_HIGHER_EDUCATION_HD'),
	('CIVIC_COLD_WAR',												'CIVIC_NUCLEAR_PROGRAM'),
	('CIVIC_PROFESSIONAL_SPORTS',							'CIVIC_FINANCE_HD'),
	('CIVIC_RAPID_DEPLOYMENT',								'CIVIC_COLD_WAR'),
	('CIVIC_RAPID_DEPLOYMENT',								'CIVIC_NEOCOLONIALISM_HD'),
	('CIVIC_SPACE_RACE',											'CIVIC_NEOCOLONIALISM_HD'),
	('CIVIC_SPACE_RACE',											'CIVIC_PROFESSIONAL_SPORTS'),
	('CIVIC_NEOCOLONIALISM_HD',								'CIVIC_HIGHER_EDUCATION_HD'),
	('CIVIC_NEOCOLONIALISM_HD',								'CIVIC_FINANCE_HD'),
	('CIVIC_MODERNISM_HD',										'CIVIC_PROFESSIONAL_SPORTS'),
	('CIVIC_INTERNATIONALISM_HD',							'CIVIC_COLD_WAR'),
	-- 信息 --
	('CIVIC_GLOBALIZATION',										'CIVIC_SPACE_RACE'),
	('CIVIC_GLOBALIZATION',										'CIVIC_RAPID_DEPLOYMENT'),
	('CIVIC_GLOBALIZATION',										'CIVIC_INTERNATIONALISM_HD'),
	('CIVIC_SOCIAL_MEDIA',										'CIVIC_SPACE_RACE'),
	('CIVIC_SOCIAL_MEDIA',										'CIVIC_MODERNISM_HD'),
...
update Civics set UITreeRow = -1 where CivicType = 'CIVIC_EARLY_EMPIRE';
	-- 古典 --
...
update Civics set UITreeRow = -1 where CivicType = 'CIVIC_MEDIEVAL_FAIRES';
update Civics set UITreeRow = 1 where CivicType = 'CIVIC_CIVIL_SERVICE';
update Civics set UITreeRow = 0 where CivicType = 'CIVIC_MERCENARIES';
	-- 文艺复兴 --
update Civics set UITreeRow = 0 where CivicType = 'CIVIC_DIPLOMATIC_SERVICE';
update Civics set UITreeRow = 1 where CivicType = 'CIVIC_HUMANISM';
update Civics set UITreeRow = 2 where CivicType = 'CIVIC_REFORMED_CHURCH';
update Civics set UITreeRow = -3 where CivicType = 'CIVIC_EXPLORATION';
	-- 工业 --
update Civics set UITreeRow = 2 where CivicType = 'CIVIC_NATIONALISM';
update Civics set UITreeRow = -2 where CivicType = 'CIVIC_COLONIALISM';
update Civics set UITreeRow = -3 where CivicType = 'CIVIC_OPERA_BALLET';
update Civics set UITreeRow = 3 where CivicType = 'CIVIC_SCORCHED_EARTH';
	-- 现代 --
update Civics set UITreeRow = 2 where CivicType = 'CIVIC_MOBILIZATION';
update Civics set UITreeRow = 1 where CivicType = 'CIVIC_IDEOLOGY';
update Civics set UITreeRow = 3 where CivicType = 'CIVIC_NUCLEAR_PROGRAM';
...
update Civics set UITreeRow = -1 where CivicType = 'CIVIC_CAPITALISM';
	-- 原子能 --
...
update Civics set UITreeRow = 1 where CivicType = 'CIVIC_RAPID_DEPLOYMENT';
update Civics set UITreeRow = -1 where CivicType = 'CIVIC_SPACE_RACE';
	-- 信息 --
update Civics set UITreeRow = 1 where CivicType = 'CIVIC_GLOBALIZATION';
...
update Civics set Cost = 900 where CivicType = 'CIVIC_EXPLORATION';
...
update Civics set Cost = 900 where CivicType = 'CIVIC_REFORMED_CHURCH';
...
update Civics set Cost = 2400 where CivicType = 'CIVIC_CONSERVATION';
...
update Civics set Cost = 2400 where CivicType = 'CIVIC_SUFFRAGE';
update Civics set Cost = 2400 where CivicType = 'CIVIC_TOTALITARIANISM';
update Civics set Cost = 2400 where CivicType = 'CIVIC_CLASS_STRUGGLE';
...
update Civics set Cost = 3000 where CivicType = 'CIVIC_CULTURAL_HERITAGE';
...
update Civics set Cost = 4500 where CivicType = 'CIVIC_CORPORATE_LIBERTARIANISM';
update Civics set Cost = 4500 where CivicType = 'CIVIC_DIGITAL_DEMOCRACY';
update Civics set Cost = 4500 where CivicType = 'CIVIC_SYNTHETIC_TECHNOCRACY';
update Civics set Cost = 4500 where CivicType = 'CIVIC_NEAR_FUTURE_GOVERNANCE';
