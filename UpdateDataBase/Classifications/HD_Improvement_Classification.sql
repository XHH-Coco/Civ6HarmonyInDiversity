insert or ignore into HD_ImprovementClassificationTypes (ImprovementClassificationType, SortIndex) values
  ...
  ('IMPROVEMENT_CLASSIFICATION_MILITARISTIC',               7),
  ('IMPROVEMENT_CLASSIFICATION_COMMERCIAL',                 8),
  ('IMPROVEMENT_CLASSIFICATION_RESIDENTIAL',                9),
  ('IMPROVEMENT_CLASSIFICATION_RELIGIOUS',                  10),
  ('IMPROVEMENT_CLASSIFICATION_LANDSCAPE',                  11),
  ('IMPROVEMENT_CLASSIFICATION_ENTERTAINING',               12),
  ('IMPROVEMENT_CLASSIFICATION_HYDRAULIC',                  13),
  ('IMPROVEMENT_CLASSIFICATION_TRANSPOTATION',              14),
  ('IMPROVEMENT_CLASSIFICATION_RENEWABLE',                  15),
