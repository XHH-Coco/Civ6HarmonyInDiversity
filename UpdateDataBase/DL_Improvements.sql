...
-- 	('P_POLDER_PRODUCTION_TIRE2',		'Placeholder',		'YIELD_PRODUCTION',		1,				1,					'IMPROVEMENT_POLDER',		'TECH_MASS_PRODUCTION',		NULL,						NULL,						NULL),
	('P_POLDER_FOOD_TIRE1',				'Placeholder',		'YIELD_FOOD',			1,				1,					'IMPROVEMENT_POLDER',		NULL,						NULL,						NULL,						NULL),
...
-- 	('P_LAND_POLDER_PRODUCTION_TIRE2',	'Placeholder',		'YIELD_PRODUCTION',		1,				1,					'IMPROVEMENT_LAND_POLDER',	'TECH_MASS_PRODUCTION',		NULL,						NULL,						NULL),
	('P_LAND_POLDER_FOOD_TIRE1',		'Placeholder',		'YIELD_FOOD',			1,				1,					'IMPROVEMENT_LAND_POLDER',	NULL,						NULL,						NULL,						NULL);
...
-- 	('LP_POLDER_PRODUCTION_TIRE2',		'Placeholder',		'YIELD_PRODUCTION',		1,				1,					'IMPROVEMENT_POLDER',		'TECH_MASS_PRODUCTION',		NULL,						NULL,						NULL),
	('LP_POLDER_FOOD_TIRE1',			'Placeholder',		'YIELD_FOOD',			1,				1,					'IMPROVEMENT_POLDER',		NULL,						NULL,						NULL,						NULL),
...
-- 	('LP_LAND_POLDER_PRODUCTION_TIRE2',	'Placeholder',		'YIELD_PRODUCTION',		1,				1,					'IMPROVEMENT_LAND_POLDER',	'TECH_MASS_PRODUCTION',		NULL,						NULL,						NULL),
	('LP_LAND_POLDER_FOOD_TIRE1',		'Placeholder',		'YIELD_FOOD',			1,				1,					'IMPROVEMENT_LAND_POLDER',	NULL,						NULL,						NULL,						NULL);
...
insert or replace into Modifiers
	(ModifierId,								ModifierType,								SubjectRequirementSetId,								SubjectStackLimit)
values
	('ICE_HOCKEY_RINK_CITY_CULTURE_ATTACH',		'MODIFIER_ALL_DISTRICTS_ATTACH_MODIFIER',	'PLOT_IS_TUNDRA_OR_SNOW_AND_IS_SPECIALTY_DISTRICT_REQUIREMENTS',					1),
