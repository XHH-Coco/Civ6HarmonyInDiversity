...
update Districts set CostProgressionModel = 'NO_COST_PROGRESSION', CostProgressionParam1 = 0, Cost = 75 where DistrictType in 
...
update Districts set Cost = 75 where DistrictType = 'DISTRICT_NEIGHBORHOOD';
