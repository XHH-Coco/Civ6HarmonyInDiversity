...
insert or replace into TraitModifiers (TraitType, ModifierId) values
	...
	('TRAIT_CIVILIZATION_FACES_OF_PEACE',	'HD_CANADA_RESOURCE_CULTURE'),
	-- LA
...
insert or replace into Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) values
	...
	('HD_CANADA_RESOURCE_CULTURE',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',									'PLOT_HAS_RESOURCE_REQUIREMENTS_AND_ON_TUNDRA_OR_SNOW');
insert or replace into ModifierArguments (ModifierId, Name, Value) values
	...
	('HD_CANADA_RESOURCE_CULTURE',				'YieldType',							'YIELD_CULTURE'),
	('HD_CANADA_RESOURCE_CULTURE',				'Amount',								1);
