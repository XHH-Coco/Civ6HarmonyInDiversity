...
values
	...
	('MODIFIER_OWNER_CITY_ADJUST_CITY_YIELD_MODIFIER',							'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CITIES_ADJUST_CITY_HOUSING_FROM_GREAT_PEOPLE',			'KIND_MODIFIER'),
	('MODIFIER_SINGLE_CITY_ADJUST_BUILDING_YIELD_MODIFIERS_FOR_DISTRICT',			'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CITIES_ADJUST_NATIONAL_PARK_TOURISM',			'KIND_MODIFIER'),
	('MODIFIER_SINGLE_CITY_ADJUST_TRAIT_AMENITY',			'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CITIES_ADJUST_TRADE_ROUTE_YIELD_FOR_DOMESTIC',			'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_CITY_YIELD_PER_POPULATION',			'KIND_MODIFIER'),
	('MODIFIER_PLAYER_ADJUST_INTERNATIONAL_TRADE_ROUTE_YIELD_MODIFIER',			'KIND_MODIFIER'),
	('MODIFIER_SINGLE_CITY_ADJUST_POLICY_AMENITY',			'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CITIES_ADJUST_PROPERTY',			'KIND_MODIFIER'),
	('MODIFIER_ALL_CITIES_ADJUST_PROPERTY',			'KIND_MODIFIER'),
	('MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_BASED_ON_APPEAL',		'KIND_MODIFIER'),
	('MODIFIER_ALL_CITIES_ADJUST_TOURISM',		'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_GREAT_PERSON_POINT_BONUS',		'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CAPITAL_CITY_ADD_POPULATION',		'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_PROPERTY',		'KIND_MODIFIER'),
	('MODIFIER_ALL_CITIES_ADJUST_IDENTITY_PER_TURN',		'KIND_MODIFIER'),
	('MODIFIER_PLAYER_UNITS_ADJUST_PROPERTY',		'KIND_MODIFIER'),
	('MODIFIER_CITY_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',		'KIND_MODIFIER'),
	('MODIFIER_SINGLE_CITY_GRANT_TRADING_POST',		'KIND_MODIFIER'),
	('MODIFIER_SINGLE_CITY_ADJUST_YIELD_BY_NUMBER_RESOURCES',		'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CITIES_ADJUST_REQUIRED_POWER',		'KIND_MODIFIER'),
	...
	('MODIFIER_ADJUST_GAME_PROPERTY',		'KIND_MODIFIER');
...
values
	...
	('MODIFIER_SINGLE_CITY_ADJUST_WONDER_ERA_PRODUCTION',						'COLLECTION_OWNER_CITY',					'EFFECT_ADJUST_WONDER_ERA_PRODUCTION'),
	...
	('MODIFIER_OWNER_CITY_ADJUST_CITY_YIELD_MODIFIER',							'COLLECTION_OWNER_CITY',			'EFFECT_ADJUST_CITY_YIELD_MODIFIER'),
	('MODIFIER_PLAYER_CITIES_ADJUST_CITY_HOUSING_FROM_GREAT_PEOPLE',			'COLLECTION_PLAYER_CITIES',			'EFFECT_ADJUST_CITY_HOUSING_FROM_GREAT_PEOPLE'),
	('MODIFIER_SINGLE_CITY_ADJUST_BUILDING_YIELD_MODIFIERS_FOR_DISTRICT',			'COLLECTION_OWNER_CITY',			'EFFECT_ADJUST_BUILDING_YIELD_MODIFIERS_FOR_DISTRICT'),
	('MODIFIER_PLAYER_CITIES_ADJUST_NATIONAL_PARK_TOURISM',			'COLLECTION_PLAYER_CITIES',			'EFFECT_ADJUST_CITY_NATIONAL_PARK_TOURISM'),
	('MODIFIER_SINGLE_CITY_ADJUST_TRAIT_AMENITY',			'COLLECTION_OWNER',		'EFFECT_ADJUST_TRAIT_AMENITY'),
	('MODIFIER_PLAYER_CITIES_ADJUST_TRADE_ROUTE_YIELD_FOR_DOMESTIC',			'COLLECTION_PLAYER_CITIES',		'EFFECT_ADJUST_CITY_TRADE_ROUTE_YIELD_FOR_DOMESTIC'),
	('MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_CITY_YIELD_PER_POPULATION',			'COLLECTION_PLAYER_CAPITAL_CITY',		'EFFECT_ADJUST_CITY_YIELD_PER_POPULATION'),
	('MODIFIER_PLAYER_ADJUST_INTERNATIONAL_TRADE_ROUTE_YIELD_MODIFIER',			'COLLECTION_OWNER',		'EFFECT_ADJUST_PLAYER_INTERNATIONAL_TRADE_ROUTE_YIELD_MODIFIER'),
	('MODIFIER_SINGLE_CITY_ADJUST_POLICY_AMENITY',			'COLLECTION_OWNER_CITY',		'EFFECT_ADJUST_POLICY_AMENITY'),
	('MODIFIER_PLAYER_CITIES_ADJUST_PROPERTY',			'COLLECTION_PLAYER_CITIES',		'EFFECT_ADJUST_CITY_PROPERTY'),
	('MODIFIER_ALL_CITIES_ADJUST_PROPERTY',			'COLLECTION_ALL_CITIES',		'EFFECT_ADJUST_CITY_PROPERTY'),
	('MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_BASED_ON_APPEAL',		'COLLECTION_OWNER',					'EFFECT_ADJUST_DISTRICT_YIELD_BASED_ON_APPEAL'),
	('MODIFIER_ALL_CITIES_ADJUST_TOURISM',		'COLLECTION_ALL_CITIES',					'EFFECT_ADJUST_CITY_TOURISM'),
	('MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_GREAT_PERSON_POINT_BONUS',		'COLLECTION_PLAYER_CAPITAL_CITY',					'EFFECT_ADJUST_CITY_GREAT_PERSON_POINTS_MODIFIER'),
	('MODIFIER_PLAYER_CAPITAL_CITY_ADD_POPULATION',		'COLLECTION_PLAYER_CAPITAL_CITY',					'EFFECT_ADJUST_CITY_POPULATION'),
	('MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_PROPERTY',		'COLLECTION_PLAYER_CAPITAL_CITY',					'EFFECT_ADJUST_CITY_PROPERTY'),
	('MODIFIER_ALL_CITIES_ADJUST_IDENTITY_PER_TURN',		'COLLECTION_ALL_CITIES',					'EFFECT_ADJUST_CITY_IDENTITY_PER_TURN'),
	('MODIFIER_PLAYER_UNITS_ADJUST_PROPERTY',		'COLLECTION_PLAYER_UNITS',					'EFFECT_ADJUST_UNIT_PROPERTY'),
	('MODIFIER_CITY_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',		'COLLECTION_CITY_DISTRICTS',					'EFFECT_ADJUST_DISTRICT_BASE_YIELD_CHANGE'),
	('MODIFIER_SINGLE_CITY_GRANT_TRADING_POST',		'COLLECTION_OWNER_CITY',					'EFFECT_GRANT_CITY_TRADING_POST'),
	('MODIFIER_SINGLE_CITY_ADJUST_YIELD_BY_NUMBER_RESOURCES',		'COLLECTION_OWNER_CITY',					'EFFECT_ADJUST_YIELD_BY_NUMBER_OF_RESOURCES'),
	('MODIFIER_PLAYER_CITIES_ADJUST_REQUIRED_POWER',		'COLLECTION_PLAYER_CITIES',					'EFFECT_ADJUST_CITY_REQUIRED_POWER'),
	...
	('MODIFIER_ADJUST_GAME_PROPERTY',		'COLLECTION_OWNER',					'EFFECT_ADJUST_GAME_PROPERTY');
