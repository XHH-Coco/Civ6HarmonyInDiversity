...
values
	('MANDIR_SPECIAL_DISTRICT_FOOD',		'MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_CHANGE',	'DISTRICT_IS_SPECIALTY_DISTRICT_REQUIREMENTS'),
	('MANDIR_SPECIAL_DISTRICT_FAITH',		'MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_CHANGE',	'DISTRICT_IS_SPECIALTY_DISTRICT_REQUIREMENTS');
