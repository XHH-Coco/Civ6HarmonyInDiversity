...
update Resources set LakeEligible = 0 where ResourceType = 'RESOURCE_SPONGE' or ResourceType = 'RESOURCE_SEA_URCHIN' or ResourceType = 'RESOURCE_ORCA' or
	ResourceType = 'RESOURCE_COD' or ResourceType = 'RESOURCE_MUSSELS' or ResourceType = 'RESOURCE_CORAL' or ResourceType = 'RESOURCE_MACKEREL' or ResourceType = 'RESOURCE_ALGAE';
...
values
	...
	('RESOURCE_SANDALWOOD',		'YIELD_FAITH',			2),
	('RESOURCE_SAKURA',			'YIELD_FOOD',		1),
	...
	('RESOURCE_HAM',			'YIELD_GOLD',			1),
	('RESOURCE_MAPLE',			'YIELD_CULTURE',			1),
	('RESOURCE_MAPLE',			'YIELD_GOLD',			1),
	('RESOURCE_CORAL',			'YIELD_CULTURE',			1),
	('RESOURCE_CORAL',			'YIELD_GOLD',			1),
	('RESOURCE_CAVIAR',			'YIELD_FOOD',			1),
	('RESOURCE_CAVIAR',			'YIELD_GOLD',			1),
	('RESOURCE_MACKEREL',			'YIELD_GOLD',			4),
	('RESOURCE_ALGAE',			'YIELD_FOOD',			1),
	('RESOURCE_ALGAE',			'YIELD_GOLD',			1),
	('RESOURCE_GOLD2',		'YIELD_SCIENCE',		1),
	('RESOURCE_GOLD2',		'YIELD_GOLD',			1),
	('RESOURCE_POTATO',			'YIELD_FOOD',			1),
	('RESOURCE_POTATO',			'YIELD_GOLD',			1),
	('RESOURCE_MUSHROOMS',		'YIELD_FAITH',			2),
	-- 加成
...
values
	...
	('RESOURCE_SEASHELLS',		'TERRAIN_DESERT'),
	('RESOURCE_SEASHELLS',		'TERRAIN_DESERT_HILLS'),
	('RESOURCE_SEASHELLS',		'TERRAIN_PLAINS_HILLS'),
	('RESOURCE_SEASHELLS',		'TERRAIN_GRASS_HILLS'),
	('RESOURCE_SEASHELLS',		'TERRAIN_TUNDRA_HILLS'),
	('RESOURCE_SORGHUM',		'TERRAIN_GRASS'),
	('RESOURCE_SORGHUM',		'TERRAIN_PLAINS'),
	('RESOURCE_MUSHROOMS',		'TERRAIN_GRASS'),
	('RESOURCE_MUSHROOMS',		'TERRAIN_PLAINS'),
	('RESOURCE_CAVIAR',		'TERRAIN_COAST'),
	('RESOURCE_MACKEREL',		'TERRAIN_COAST'),
	('RESOURCE_ALGAE',		'TERRAIN_COAST'),
	('RESOURCE_POTATO',		'TERRAIN_PLAINS_HILLS'),
	('RESOURCE_POTATO',		'TERRAIN_GRASS_HILLS'),
	-- 加成
...
where not exists (select FeatureType from Features where FeatureType = 'FEATURE_JNR_SAVANNAH');
...
values
	...
	('RESOURCE_TRAVERTINE',		'FEATURE_FOREST'),
	...
	('RESOURCE_SEASHELLS',		'FEATURE_MARSH'),
	('RESOURCE_SEASHELLS',		'FEATURE_OASIS'),
	('RESOURCE_SEASHELLS',		'FEATURE_VOLCANIC_SOIL'),
	...
	('RESOURCE_SORGHUM',		'FEATURE_OASIS'),
	('RESOURCE_MAPLE',		'FEATURE_FOREST'),
	('RESOURCE_MAPLE',		'FEATURE_JUNGLE'),
	('RESOURCE_CORAL',		'FEATURE_REEF'),
	('RESOURCE_OXEN',		'FEATURE_FLOODPLAINS'),
	('RESOURCE_OXEN',		'FEATURE_FLOODPLAINS_GRASSLAND'),
	('RESOURCE_OXEN',		'FEATURE_FLOODPLAINS_PLAINS'),
	('RESOURCE_OXEN',		'FEATURE_MARSH'),
	('RESOURCE_GOLD2',		'FEATURE_MARSH'),
	('RESOURCE_GOLD2',		'FEATURE_VOLCANIC_SOIL'),
	('RESOURCE_GOLD2',		'FEATURE_GEOTHERMAL_FISSURE'),
	('RESOURCE_POTATO',		'FEATURE_FLOODPLAINS'),
	-- 加成
...
insert or replace into Resource_ValidFeatures
	(ResourceType,				FeatureType)
select
	'RESOURCE_MACKEREL',				'FEATURE_SUK_KELP'
where exists (select FeatureType from Features where FeatureType = 'FEATURE_SUK_KELP');

insert or replace into Resource_ValidFeatures
	(ResourceType,				FeatureType)
select
	'RESOURCE_ALGAE',				'FEATURE_SUK_KELP'
where exists (select FeatureType from Features where FeatureType = 'FEATURE_SUK_KELP');
...
values
	...
	('RESOURCE_MAIZE',				4),
	('RESOURCE_SUK_OBSIDIAN',		4),
	('RESOURCE_SUK_CHEESE',			4),
	('RESOURCE_GOLD',				4);
