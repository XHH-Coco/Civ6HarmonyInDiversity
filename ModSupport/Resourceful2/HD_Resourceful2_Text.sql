...
values
	...
	("zh_Hans_CN",	"LOC_IMPROVEMENT_LUMBER_MILL_HD_DESCRIPTION",				 "解锁“轮子”科技后，若沿河，额外+1 [ICON_Production] 生产力；解锁“机械”科技后失效。[NEWLINE][NEWLINE]只能在森林或有效资源上建造。解锁“公会”市政后也能建造在雨林上。"), 
