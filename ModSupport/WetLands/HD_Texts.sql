...
values
	...
	("zh_Hans_CN",  "LOC_IMPROVEMENT_JNR_OASIS_FARM_DESCRIPTION",               "+1 [ICON_Culture] 文化值，+1 [ICON_AMENITIES] 宜居度。城市若拥有测量仪，+1 [ICON_Culture] 文化值。每相邻1个娱乐中心+1 [ICON_Culture] 文化值。研究封建主义市政后，每相邻1个社区+1 [ICON_Food] 食物。研究城市化市政、制冷技术科技和虚拟现实科技后，分别+1 [ICON_AMENITIES] 宜居度。随着科技与市政的研究将提供更多产出。为相邻单元格+1魅力。[NEWLINE][NEWLINE]只能建造在绿洲上。"),
	("zh_Hans_CN",  "LOC_IMPROVEMENT_JNR_REED_HOME_NAME",                       "芦苇屋"),
	("zh_Hans_CN",  "LOC_IMPROVEMENT_JNR_REED_HOME_DESCRIPTION",                "+1 [ICON_Production] 生产力，+1 [ICON_SCIENCE] 科技值。城市若拥有测量仪，+1 [ICON_SCIENCE] 科技值。研究造纸术科技后，每相邻1个学院+1 [ICON_SCIENCE] 科技值。每相邻1个堤坝+1 [ICON_Production] 生产力。随着科技与市政的研究将提供更多产出。[NEWLINE][NEWLINE]可建造在沼泽或泛滥平原上。"),
	...
	("zh_Hans_CN",	"LOC_IMPROVEMENT_MOAI_DESCRIPTION",													"+2 [ICON_Culture] 文化值。在火山土上或与其相邻时+2 [ICON_Culture] 文化值。相邻湖泊或近海时+1 [ICON_Culture] 文化值。与每2个摩艾石像相邻+1 [ICON_Culture] 文化值，解锁“中世纪集市”后变为每与1个摩艾石像相邻。获得等同于 [ICON_Culture] 文化值产出的 [ICON_Tourism] 旅游业绩。只可建在平原、平原丘陵、草原、草原丘陵或火山土单元格之上。不能建造在相邻树林或雨林的单元格上。");