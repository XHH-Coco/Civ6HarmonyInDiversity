...
insert or replace into EnglishText
    (Tag,                                                           Text)
values
    ("LOC_IMPROVEMENT_LEU_STATION_DESCRIPTION",                     "Railroads are instantly built on current and adjacent passable land tiles. Each type of adjacent Specialized districts or adjacent Aqueduct provide corresponding yield to International [ICON_TradeRoute] Trade Routes from this city. This bonus is doubled if this city is fully [ICON_POWER] Powered. Improvements of this City provided +100% [ICON_TOURISM] Tourism. [NEWLINE][NEWLINE]Cannot be built Marsh, Swamp or Geothermal Fissure tiles. Only one may be built in each city, and may not be built adjacent to another Station.");
...
values
    ...
    ("zh_Hans_CN",  "LOC_UNIT_LEU_TYCOON_NOMONOPOLY_DESCRIPTION",      "需要“建造工坊”方可建造或购买的高价平民单位。[NEWLINE][NEWLINE]可以创建铁路和火车站来改善你的领土上的区域产出、贸易和 [ICON_PRODUCTION] 生产力。"),
    ("zh_Hans_CN",  "LOC_STATION_ADJ_PRODUCTION",                      "+{1_num} [ICON_PRODUCTION] 生产力来自相邻火车站。"),
    ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_STATION_NAME",                "火车站"),
    ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_STATION_DESCRIPTION",         "在所在单元格和所有相邻的可通行陆地单元格上自动创建铁路。相邻的每种专业化区域或水渠为本城出发的国际 [ICON_TradeRoute] 贸易路线提供对应产出；此城 [ICON_POWER] 供电充足时效果翻倍。本城改良提供的 [ICON_TOURISM] 旅游业绩+100%。[NEWLINE][NEWLINE]不能建在沼泽或地热裂缝上，一座城市只能拥有一个火车站，火车站不能与另一个火车站相邻。");
...
-- --------------------------------------------------------------------
    ("zh_Hans_CN", 
    "LOC_LEU_GREATPERSON_FREE_TYCOON",                   
    "立即获得一个大亨。"),
    ("en_US", 
    "LOC_LEU_GREATPERSON_FREE_TYCOON",                   
    "Receives a free Tycoon."),
    ("zh_Hans_CN", 
    "LOC_PIERO_DE_BARDI_TYCOON_PRODUCTION",                   
    "所有城市生产大亨+50%建造速度。"),
    ("en_US", 
    "LOC_PIERO_DE_BARDI_TYCOON_PRODUCTION",                   
