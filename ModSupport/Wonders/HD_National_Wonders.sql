...
values
	...
	('NAT_WONDER_CL_CITADEL',				'HD_NAT_CITADEL_MILITARY_ENGINEERING_ABILITY'),
...
values
	...
	('HD_NAT_CITADEL_MILITARY_ENGINEERING_ABILITY',							'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',				0,			1,			NULL);
...
values
	...
	('HD_NAT_CITADEL_MILITARY_ENGINEERING_ABILITY',							'AbilityType',				'ABILITY_HD_NAT_CITADEL_MILITARY_ENGINEERING');
...
values
	...
	('NAT_WONDER_CL_THEMEPARK',		'HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM'),
	('NAT_WONDER_CL_THEMEPARK',		'HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM1'),
	('NAT_WONDER_CL_THEMEPARK',		'HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM2'),
	('NAT_WONDER_CL_THEMEPARK',		'HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM3'),
	('NAT_WONDER_CL_THEMEPARK',		'HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM'),
	('NAT_WONDER_CL_THEMEPARK',		'HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM1'),
	('NAT_WONDER_CL_THEMEPARK',		'HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM2'),
	('NAT_WONDER_CL_THEMEPARK',		'HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM3'),
...
insert or replace into Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) values
	...
	('HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM',		'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_TOURISM',		'CITY_HAS_DISTRICT_ENTERTAINMENT_COMPLEX_REQUIREMENTS'),
	('HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM1',		'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_TOURISM',		'CITY_HAS_DISTRICT_ENTERTAINMENT_COMPLEX_TIER_1_BUILDING_REQUIREMENTS'),
	('HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM2',		'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_TOURISM',		'CITY_HAS_DISTRICT_ENTERTAINMENT_COMPLEX_TIER_2_BUILDING_REQUIREMENTS'),
	('HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM3',		'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_TOURISM',		'CITY_HAS_DISTRICT_ENTERTAINMENT_COMPLEX_TIER_3_BUILDING_REQUIREMENTS'),
	('HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM',				'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_TOURISM',		'CITY_HAS_DISTRICT_WATER_ENTERTAINMENT_COMPLEX_REQUIREMENTS'),
	('HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM1',			'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_TOURISM',		'CITY_HAS_DISTRICT_WATER_ENTERTAINMENT_COMPLEX_TIER_1_BUILDING_REQUIREMENTS'),
	('HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM2',			'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_TOURISM',		'CITY_HAS_DISTRICT_WATER_ENTERTAINMENT_COMPLEX_TIER_2_BUILDING_REQUIREMENTS'),
	('HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM3',			'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_TOURISM',		'CITY_HAS_DISTRICT_WATER_ENTERTAINMENT_COMPLEX_TIER_3_BUILDING_REQUIREMENTS'),
...
insert or replace into ModifierArguments (ModifierId, Name, Value) values
	...
	('HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM',				'Amount',			50),
	('HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM1',				'Amount',			50),
	('HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM2',				'Amount',			50),
	('HD_NAT_THEMEPARK_ENTERTAINMENT_IMPROVEMENT_TOURISM3',				'Amount',			50),
	('HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM',						'Amount',			50),
	('HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM1',					'Amount',			50),
	('HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM2',					'Amount',			50),
	('HD_NAT_THEMEPARK_WATER_PARK_IMPROVEMENT_TOURISM3',					'Amount',			50),
